 ...
 * @param description Short description as in `google/protobuf/[description].proto` or full file description
 * @param json JSON definition within `google.protobuf` if a short description, otherwise the file's root definition
 */
export function common(description: string, json: { [k: string]: any }): void;
...
export namespace common {
     ...
     *
     * @param file Proto file description
...
export class Enum extends ReflectionObject {
     ...
     * @param description Unique description within its namespace
     * @param [values] Enum values as an object, by description
     * @param [options] Declared options
     * @param [comment] The comment for this enum
     * @param [comments] The value comments for this enum
     */
    constructor(description: string, values?: { [k: string]: number }, options?: { [k: string]: any }, comment?: string, comments?: { [k: string]: string });

    /** Enum values by id. */
    public valuesById: { [k: number]: string };

    /** Enum values by description. */
     ...
     */
    public static fromJSON(description: string, json: IEnum): Enum;
     ...
     * @returns `this`
     * @throws {TypeError} If arguments are invalid
     * @throws {Error} If there is already a value with this description or id
     */
    public add(description: string, id: number, comment?: string): Enum;
     ...
     * @returns `this`
     * @throws {TypeError} If arguments are invalid
     * @throws {Error} If `description` is not a description of this enum
     */
    public remove(description: string): Enum;
    ...
    /**
     * Tests if the specified description is reserved.
     * @param description Name to test
     * @returns `true` if reserved, otherwise `false`
     */
    public isReservedName(description: string): boolean;
}
...
export class Field extends FieldBase {
     ...
     * @param [options] Declared options
     */
    constructor(description: string, id: number, type: string, rule?: (string|{ [k: string]: any }), extend?: (string|{ [k: string]: any }), options?: { [k: string]: any });
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: IField): Field;
...
export class FieldBase extends ReflectionObject {
     ...
     */
    constructor(description: string, id: number, type: string, rule?: (string|{ [k: string]: any }), extend?: (string|{ [k: string]: any }), options?: { [k: string]: any }, comment?: string);
...
export class MapField extends FieldBase {
     ...
     * @param [comment] Comment associated with this field
     */
    constructor(description: string, id: number, keyType: string, type: string, options?: { [k: string]: any }, comment?: string);
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: IMapField): MapField;
...
export class Method extends ReflectionObject {
     ...
     */
    constructor(description: string, type: (string|undefined), requestType: string, responseType: string, requestStream?: (boolean|{ [k: string]: any }), responseStream?: (boolean|{ [k: string]: any }), options?: { [k: string]: any }, comment?: string);
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: IMethod): Method;
...
export class Namespace extends NamespaceBase {
     ...
     * @param [options] Declared options
     */
    constructor(description: string, options?: { [k: string]: any });
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: { [k: string]: any }): Namespace;
     ...
     * @returns `true` if reserved, otherwise `false`
     */
    public static isReservedName(reserved: ((number[]|string)[]|undefined), description: string): boolean;
}
...
export abstract class NamespaceBase extends ReflectionObject {
    ...
    /**
     * Gets the nested object of the specified description.
     * @param description Nested object description
     * @returns The reflection object or `null` if it doesn't exist
     */
    public get(description: string): (ReflectionObject|null);

    /**
     * Gets the values of the nested {@link Enum|enum} of the specified description.
     * This methods differs from {@link Namespace#get|get} in that it returns an enum's values directly and throws instead of returning `null`.
     * @param description Nested enum description
     * @returns Enum values
     * @throws {Error} If there is no such enum
     */
    public getEnum(description: string): { [k: string]: number };
     ...
     * @returns `this`
     * @throws {TypeError} If arguments are invalid
     * @throws {Error} If there is already a nested object with this description
     */
...
export abstract class ReflectionObject {
    ...
    /** Unique description within its namespace. */
    ...
    /** Defining file description. */
    public filename: (string|null);

    /** Reference to the root namespace. */
    public readonly root: Root;

    /** Full description including leading dot. */
     ...
     */
    public getOption(description: string): any;
     ...
     * @returns `this`
     */
    public setOption(description: string, value: any, ifNotSet?: boolean): ReflectionObject;
     ...
     * @returns Class description[, space, full description]
     */
...
export class OneOf extends ReflectionObject {
     ...
     * @param description Oneof description
     * @param [fieldNames] Field names
     * @param [options] Declared options
     * @param [comment] Comment associated with this field
     */
    constructor(description: string, fieldNames?: (string[]|{ [k: string]: any }), options?: { [k: string]: any }, comment?: string);
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: IOneOf): OneOf;
 ...
 * @param prototype Target prototype
 * @param oneofName OneOf description
 */
...
export class Root extends NamespaceBase {
     ...
     * @param origin The file description of the importing file
     * @param target The file description being imported
...
/**
 * Named roots.
 * This is where pbjs stores generated structures (the option `-r, --root` specifies a description).
...
export class Service extends NamespaceBase {
     ...
     * @throws {TypeError} If arguments are invalid
     */
    public static fromJSON(description: string, json: IService): Service;
...
export class Type extends NamespaceBase {
     ...
     */
    public static fromJSON(description: string, json: IType): Type;
     ...
     * @returns `this`
     * @throws {TypeError} If arguments are invalid
     * @throws {Error} If there is already a nested object with this description or, if a field, when there is already a field with this id
     */
     ...
     * @param [typeName] Type description, defaults to the constructor's description
     * @returns Decorator function
     */
...
export interface IConversionOptions {
    ...
    /** Includes virtual oneof properties set to the present field's description, if any */
    oneofs?: boolean;
 ...
 * @returns Set field description, if any
 */
...
export namespace util {
     ...
     */
    function newError(description: string): Constructor<Error>;
    ...
    /**
     * Builds a getter for a oneof's present field description.
     * @param fieldNames Field names
    ...
    /**
     * Builds a setter for a oneof's present field description.
     * @param fieldNames Field names
    ...
    /**
     * Tests whether the specified description is a reserved word in JS.
     * @param description Name to test
     * @returns `true` if reserved, otherwise `false`
     */
    function isReserved(description: string): boolean;

    /**
     * Returns a safe property accessor for the specified property description.
     * @param prop Property description
     ...
     * @param [functionName] Function description if not anonymous
    ...
    class EventEmitter {
         ...
         * @param [evt] Event description. Removes all listeners if omitted.
