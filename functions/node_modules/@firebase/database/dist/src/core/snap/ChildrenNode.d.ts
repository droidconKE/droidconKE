 ...
 * list of children in the children property, sorted by child description.
 *
 * @constructor
 * @implements {Node}
 */
export declare class ChildrenNode implements Node {
    ...
    /**
     * Given an index, return the key description of the largest value we have, according to that index
     * @param {!Index} indexDefinition
     * @return {?string}
     */
