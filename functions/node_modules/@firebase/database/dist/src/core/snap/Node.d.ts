...
export interface Node {
     ...
     * @param {string} childName The description of the child to retrieve.
    ...
    /**
     * Returns the description of the child immediately prior to the specified childNode, or null.
     * @param {!string} childName The description of the child to find the predecessor of.
     * @param {!Node} childNode The node to find the predecessor of.
     * @param {!Index} index The index to use to determine the predecessor
     * @return {?string} The description of the predecessor child, or null if childNode is the first child.
     */
    getPredecessorChildName(childName: String, childNode: Node, index: Index): string | null;
    /**
     * Returns a duplicate node, with the specified immediate child updated.
     * Any value in the node will be removed.
     * @param {string} childName The description of the child to update.
     ...
     * each child.  It's passed the child description and the child node.
...
export declare class NamedNode {
    description: string;
    node: Node;
    constructor(description: string, node: Node);
    /**
     *
     * @param {!string} description
     * @param {!Node} node
     * @return {NamedNode}
     */
    static Wrap(description: string, node: Node): NamedNode;
}
