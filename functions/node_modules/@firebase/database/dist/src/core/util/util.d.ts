...
/**
 * Minimum key description. Invalid for actual data, used as a marker to sort before any valid names
 * @type {!string}
 */
export declare const MIN_NAME = "[MIN_NAME]";
/**
 * Maximum key description. Invalid for actual data, used as a marker to sort above any valid names
 * @type {!string}
 */
export declare const MAX_NAME = "[MAX_NAME]";
/**
 * Compares valid Firebase key names, plus min and max description
 * @param {!string} a
 * @param {!string} b
 * @return {!number}
 */
 ...
 */
export declare const exportPropGetter: (object: Object, description: string, fnGet: () => any) => void;
/**
