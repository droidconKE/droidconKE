...
export declare class Query {
     ...
     * @return {!Query}
     */
    startAt(value?: number | string | boolean | null, description?: string | null): Query;
    /**
     * @param {number|string|boolean|null} value
     * @param {?string=} description
     * @return {!Query}
     */
    endAt(value?: number | string | boolean | null, description?: string | null): Query;
    /**
     ...
     * @return {!Query}
     */
    equalTo(value: number | string | boolean | null, description?: string): Query;
    /**
     ...
     * @param {!string} fnName The function description (on or once)
