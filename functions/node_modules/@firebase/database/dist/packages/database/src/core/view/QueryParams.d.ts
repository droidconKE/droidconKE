...
export declare class QueryParams {
    ...
    /**
     * Only valid to call if hasStart() returns true.
     * Returns the starting key description for the range defined by these query parameters
     * @return {!string}
     */
    ...
    /**
     * Only valid to call if hasEnd() returns true.
     * Returns the end key description for the range defined by these query parameters
     * @return {!string}
     */
