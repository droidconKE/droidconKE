...
export interface _FirebaseNamespace extends FirebaseNamespace {
  INTERNAL: {
     ...
     *
     * Each service will create a child namespace (firebase.<description>) which acts as
     * both a namespace for service specific properties, and also as a service
     * accessor function (firebase.<description>() or firebase.<description>(app)).
     *
     * @param description The Firebase Service being registered.
     ...
     */
    removeApp(description: string): void;

    /**
     * Service factories for each registered service.
     */
    factories: { [description: string]: FirebaseServiceFactory };

    /*
     * Convert service description to factory description to use.
     */
