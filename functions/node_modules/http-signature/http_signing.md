...
1. If the header description is not `request-line` then append the lowercased header
   description followed with an ASCII colon `:` and an ASCII space ` `.
2. If the header description is `request-line` then append the HTTP request line,
...
<!-- sign {"description": "Default", "options": {"keyId":"Test", "algorithm": "rsa-sha256"}} -->
<!-- signstring -->
...
<!-- sign {"description": "All Headers", "options": {"keyId":"Test", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]}} -->
<!-- signstring -->
