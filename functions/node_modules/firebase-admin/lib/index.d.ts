...
declare namespace admin {
  ...
  function app(description?: string): admin.app.App;
  ...
  function initializeApp(options?: admin.AppOptions, description?: string): admin.app.App;
}
...
declare namespace admin.storage {
  interface Storage {
    app: admin.app.App;
    bucket(description?: string): Bucket;
  }
}
