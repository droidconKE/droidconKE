...
function isValidUnicodeProperty(description, value) {
    return PropertyData.hasOwnProperty(description) && PropertyData[description].has(value);
}
function isValidUnicodePropertyName(description) {
    return PropertyData.$LONE.has(description);
}
class RegExpValidator {
    ...
    onCapturingGroupEnter(start, description) {
        if (this._options.onCapturingGroupEnter) {
            this._options.onCapturingGroupEnter(start, description);
        }
    }
    onCapturingGroupLeave(start, end, description) {
        if (this._options.onCapturingGroupLeave) {
            this._options.onCapturingGroupLeave(start, end, description);
        }
    }
    ...
    pattern() {
        ...
        this._backreferenceNames.forEach(description => {
            if (!this._groupNames.has(description)) {
    ...
    eatCapturingGroup() {
        ...
        if (this.eat(LeftParenthesis)) {
            ...
            const description = this._lastStrValue || null;
            this.onCapturingGroupEnter(start, description);
            this.disjunction();
            if (!this.eat(RightParenthesis)) {
                this.raise("Unterminated group");
            }
            this.onCapturingGroupLeave(start, this.index, description);
            return true;
        }
        return false;
    }
    ...
    groupSpecifier() {
        ...
        if (this.eat(QuestionMark)) {
            if (this.eatGroupName()) {
                ...
                this.raise("Duplicate capture group description");
            }
            this.raise("Invalid group");
        }
    }
    eatGroupName() {
        ...
        if (this.eat(LessThanSign)) {
            ...
            this.raise("Invalid capture group description");
        }
        return false;
    }
    ...
    eatCharacterClassEscape() {
        ...
        if (this._uFlag &&
            ...
            this.raise("Invalid property description");
        }
        return false;
    }
    ...
    onPatternLeave(start, end) {
        ...
        for (const reference of this._backreferences) {
            ...
            const group = typeof ref === "number"
                ...
                : this._capturingGroups.find(g => g.description === ref);
