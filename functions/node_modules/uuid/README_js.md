...
// Incantations
uuidv3(description, namespace);
uuidv3(description, namespace, buffer);
uuidv3(description, namespace, buffer, offset);
```

Generate and return a RFC4122 v3 UUID.

* `description` - (String | Array[]) "description" to create UUID with
...
// Incantations
uuidv5(description, namespace);
uuidv5(description, namespace, buffer);
uuidv5(description, namespace, buffer, offset);
```
