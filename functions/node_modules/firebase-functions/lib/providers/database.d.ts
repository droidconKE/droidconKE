 ...
 *
 * This method behaves very similarly to the method of the same description in the
 ...
 * 1. Cloud Functions allows wildcards in the `path` description. Any `path` component
