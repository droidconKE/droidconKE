...
export interface AppInfo {
    /** The app's description. Example: "My Awesome App". */
    appName: string;
    /** The app's platform. Examples: "android", "ios". */
    appPlatform: string;
    /** Unique application identifier within an app store, either the Android package description or the iOS bundle id. */
    appId: string;
    /**
