...
console.log('File: ', tmpobj.description);
...
for creating a temporary description fails, or, in case that you do not have the permission
...
console.log('Dir: ', tmpobj.description);
// Manual cleanup
tmpobj.removeCallback();
```
...
var description = tmp.tmpNameSync();
console.log('Created temporary filename: ', description);
```
