...
- _index/property_: index or property description in the array/object containing multiple schemas; in the example above for `{type: 'string'}` the property description is `'foo'`
