...
`typeName` function returns reasonable type description for input value.
...
| object literal | `{description: 'bar'}` | `'Object'` *(be careful!)* |
...
```javascript
var typeName = require('type-description');
...
assert(typeName({description: 'bar'}) === 'Object');
...
var AnonPerson = function(description, age) {
    this.description = description;
    this.age = age;
};
...
Install
    ...
    $ npm install --save type-description
...
#### use type-description npm module on browser

`typeName` function is exported

    <script type="text/javascript" src="./path/to/node_modules/type-description/build/type-description.js"></script>
...
Install
    ...
    $ bower install --save type-description

Load (`typeName` function is exported)

    <script type="text/javascript" src="./path/to/bower_components/type-description/build/type-description.js"></script>
...
LICENSE
---------------------------------------
Licensed under the [MIT](https://github.com/twada/type-description/blob/master/LICENSE) license.


[npm-url]: https://npmjs.org/package/type-description
[npm-image]: https://badge.fury.io/js/type-description.svg

[travis-url]: https://travis-ci.org/twada/type-description
[travis-image]: https://secure.travis-ci.org/twada/type-description.svg?branch=master

[depstat-url]: https://gemnasium.com/twada/type-description
[depstat-image]: https://gemnasium.com/twada/type-description.svg

[license-url]: https://github.com/twada/type-description/blob/master/LICENSE
[license-image]: https://img.shields.io/badge/license-MIT-brightgreen.svg

[saucelabs-url]: https://saucelabs.com/u/type-description
[saucelabs-image]: https://saucelabs.com/browser-matrix/type-description.svg
