...
- `format` -- String description of format to use, valid options are:
...
- `options` -- Optional Object, extra options, with keys:
  - `filename` -- Optional String, description for the key being parsed
...
Only present if `this.type === 'ecdsa'`, string containing the description of the
...
- `format` -- String description of format to use, for valid options see `parseKey()`
...
- `algorithm` -- String description of hash algorithm to use, valid options are `md5`,
...
- `hashAlgorithm` -- optional String description of hash algorithm to use, any
...
- `format` -- optional String, description of format to interpret given String with.
...
- `format` -- String description of format to use, valid options are listed under
...
- `algorithm` -- a String, description of the algorithm to be used, possible values
                 are `rsa`, `dsa`, `ecdsa`
...
Parameters
 ...
 - `hashAlgo` -- an optional String, any hash function description
...
Parameters
 ...
 - `hostname` -- the fully qualified DNS description of the host
...
Parameters
 ...
 - `uid` -- a String, user identifier (login description)
