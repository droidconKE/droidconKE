...
messages. This description is due to [@fronx](https://github.com/fronx), on the basis
...
design and to [@fronx](https://github.com/fronx) for helping description things.
