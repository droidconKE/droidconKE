    ...
    if(depth === 0) {
      ...
      if(cn !== 'example.com') {
        verified = {
          ...
          message: 'Certificate common description does not match hostname.'
        };
      }
    }
    return verified;
  ...
  verify: function(connection, verified, depth, certs) {
    if(depth === 0) {
      ...
      if(cn !== 'the-client') {
        verified = {
          alert: forge.tls.Alert.Description.bad_certificate,
          message: 'Certificate common description does not match expected client.'
        };
      }
    }
    return verified;
...
var extensions = csr.getAttribute({description: 'extensionRequest'}).extensions;
...
// get an attribute
csr.getAttribute({description: 'challengePassword'});

// get extensions array
csr.getAttribute({description: 'extensionRequest'}).extensions;

```

<a description="pkcs12" />
...
var publicKeyValidator = {
  ...
  value: [{
    description: 'SubjectPublicKeyInfo.AlgorithmIdentifier',
    tagClass: asn1.Class.UNIVERSAL,
    type: asn1.Type.SEQUENCE,
    constructed: true,
    value: [{
      description: 'AlgorithmIdentifier.algorithm',
      tagClass: asn1.Class.UNIVERSAL,
      type: asn1.Type.OID,
      constructed: false,
    ...
    // subjectPublicKey
    description: 'SubjectPublicKeyInfo.subjectPublicKey',
    tagClass: asn1.Class.UNIVERSAL,
    type: asn1.Type.BITSTRING,
    constructed: false,
    value: [{
      // RSAPublicKey
      description: 'SubjectPublicKeyInfo.subjectPublicKey.RSAPublicKey',
      tagClass: asn1.Class.UNIVERSAL,
      type: asn1.Type.SEQUENCE,
      constructed: true,
      optional: true,
