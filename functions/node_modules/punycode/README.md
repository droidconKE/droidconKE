...
```js
// decode domain description parts
...
```js
// encode domain description parts
...
Converts a Punycode string representing a domain description or an email address to Unicode. Only the Punycoded parts of the input will be converted, i.e. it doesn’t matter if you call it on a string that has already been converted to Unicode.
...
Converts a lowercased Unicode string representing a domain description or an email address to Punycode. Only the non-ASCII parts of the input will be converted, i.e. it doesn’t matter if you call it with a domain that’s already in ASCII.
