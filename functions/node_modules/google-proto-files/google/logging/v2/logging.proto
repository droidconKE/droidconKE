...
message DeleteLogRequest {
  // Required. The resource description of the log to delete:
  //
...
message WriteLogEntriesRequest {
  // Optional. A default log resource description that is assigned to all log entries
...
message ListLogEntriesRequest {
  ...
  // resource description format and added to the list of resources in
  // `resource_names`.
...
message ListLogEntriesResponse {
  ...
  // speeding up the search by changing your filter to specify a single log description
...
message ListLogsRequest {
  // Required. The resource description that owns the logs:
  //
  //     "projects/[PROJECT_ID]"
  //     "organizations/[ORGANIZATION_ID]"
  //     "billingAccounts/[BILLING_ACCOUNT_ID]"
