...
message LogEntry {
  // Required. The resource description of the log to which this log entry belongs:
  //
  ...
  // slash and filtering for a log description with a leading slash will never return
  // any results.
  string log_name = 12;
  ...
  // Optional. Resource description of the trace associated with the log entry, if any.
  // If it contains a relative resource description, the description is assumed to be relative
...
message LogEntrySourceLocation {
  // Optional. Source file description. Depending on the runtime environment, this
  // might be a simple description or a fully-qualified description.
  string file = 1;
  ...
  // Optional. Human-readable description of the function or method being invoked, with
  // optional context such as the class or package description. This information may be
