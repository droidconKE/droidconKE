...
message LogMetric {
  ...
  // (`/`) denotes a hierarchy of description pieces, and it cannot be the
  ...
  //
  // The `description`, `type`, and `description` fields in the `metric_descriptor`
  // are output only, and is constructed using the `description` and `description`
  ...
  // description as the key and an extractor expression as the value in the
  ...
  //   1. field: The description of the log entry field from which the value is to be
  //      extracted.
...
message ListLogMetricsRequest {
  // Required. The description of the project containing the metrics:
  //
  //     "projects/[PROJECT_ID]"
  string parent = 1;
...
message GetLogMetricRequest {
  // The resource description of the desired metric:
  //
...
message CreateLogMetricRequest {
  // The resource description of the project in which to create the metric:
  //
  //     "projects/[PROJECT_ID]"
  //
...
message UpdateLogMetricRequest {
  // The resource description of the metric to update:
  //
  //     "projects/[PROJECT_ID]/metrics/[METRIC_ID]"
  //
  // The updated metric must be provided in the request and it's
  // `description` field must be the same as `[METRIC_ID]` If the metric
...
message DeleteLogMetricRequest {
  // The resource description of the metric to delete:
  //
  //     "projects/[PROJECT_ID]/metrics/[METRIC_ID]"
  string metric_name = 1;
}
