...
service ConfigServiceV2 {
  ...
  rpc GetExclusion(GetExclusionRequest) returns (LogExclusion) {
    option (google.api.http) = { get: "/v2/{description=*/*/exclusions/*}" };
  }
  ...
  rpc UpdateExclusion(UpdateExclusionRequest) returns (LogExclusion) {
    option (google.api.http) = { patch: "/v2/{description=*/*/exclusions/*}" body: "exclusion" };
  }

  // Deletes an exclusion.
  rpc DeleteExclusion(DeleteExclusionRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2/{description=*/*/exclusions/*}" };
  }
}
...
message LogSink {
  ...
  // from certain child projects, filter on the project part of the log description:
  //
...
message GetSinkRequest {
  // Required. The resource description of the sink:
  //
...
message CreateSinkRequest {
  ...
  // Required. The new sink, whose `description` parameter is a sink identifier that
...
message UpdateSinkRequest {
  // Required. The full resource description of the sink to update, including the
  ...
  // Required. The updated sink, whose description is the same identifier that appears
  ...
  // in the update mask.  `description` and output only fields cannot be updated.
  //
...
message DeleteSinkRequest {
  // Required. The full resource description of the sink to delete, including the
  // parent resource and the sink identifier:
  //
  //     "projects/[PROJECT_ID]/sinks/[SINK_ID]"
  //     "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
...
message GetExclusionRequest {
  // Required. The resource description of an existing exclusion:
  //
...
message CreateExclusionRequest {
  ...
  // Required. The new exclusion, whose `description` parameter is an exclusion description
...
message UpdateExclusionRequest {
  // Required. The resource description of the exclusion to update:
  //
  //     "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  //     "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  //     "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
...
message DeleteExclusionRequest {
  // Required. The resource description of an existing exclusion to delete:
  //
  //     "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  //     "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  //     "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
