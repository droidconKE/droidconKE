...
message Document {
  // The resource description of the document, for example
  ...
  //
  // A simple field description contains only characters `a` to `z`, `A` to `Z`,
  ...
  //
  // Within a field path, a quoted field description starts and ends with `` ` `` and
