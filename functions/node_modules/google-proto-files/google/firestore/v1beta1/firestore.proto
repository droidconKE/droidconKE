...
service Firestore {
  ...
  rpc GetDocument(GetDocumentRequest) returns (Document) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/databases/*/documents/*/**}" };
  }
  ...
  rpc UpdateDocument(UpdateDocumentRequest) returns (Document) {
    option (google.api.http) = { patch: "/v1beta1/{document.description=projects/*/databases/*/documents/*/**}" body: "document" };
  }

  // Deletes a document.
  rpc DeleteDocument(DeleteDocumentRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/databases/*/documents/*/**}" };
  }
...
message GetDocumentRequest {
  // The resource description of the Document to get. In the format:
...
message ListDocumentsRequest {
  // The parent resource description. In the format:
  ...
  // The order to sort results by. For example: `priority desc, description`.
  string order_by = 6;
...
message CreateDocumentRequest {
  ...
  // The document to create. `description` must not be set.
  Document document = 4;
...
message UpdateDocumentRequest {
  ...
  // None of the field paths in the mask may contain a reserved description.
  //
...
message DeleteDocumentRequest {
  // The resource description of the Document to delete. In the format:
  // `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
  string description = 1;
...
message BatchGetDocumentsRequest {
  // The database description. In the format:
...
message BatchGetDocumentsResponse {
  ...
  oneof result {
    ...
    // A document description that was requested but does not exist. In the format:
    // `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
    string missing = 2;
  }
