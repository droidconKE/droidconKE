...
message Write {
  ...
  oneof operation {
    ...
    // A document description to delete. In the format:
  ...
  // The field paths in this mask must not contain a reserved field description.
...
message DocumentTransform {
  ...
  // The description of the document to transform.
  string document = 1;
...
message DocumentDelete {
  // The resource description of the [Document][google.firestore.v1beta1.Document] that was deleted.
  string document = 1;
...
message DocumentRemove {
  // The resource description of the [Document][google.firestore.v1beta1.Document] that has gone out of view.
  string document = 1;
