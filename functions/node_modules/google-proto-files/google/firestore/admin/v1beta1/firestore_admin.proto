...
service FirestoreAdmin {
  ...
  rpc GetIndex(GetIndexRequest) returns (Index) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/databases/*/indexes/*}" };
  }

  // Deletes an index.
  rpc DeleteIndex(DeleteIndexRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/databases/*/indexes/*}" };
  }
}
...
message CreateIndexRequest {
  // The description of the database this index will apply to. For example:
  // `projects/{project_id}/databases/{database_id}`
  string parent = 1;

  // The index to create. The description and state fields are output only and will be
...
message GetIndexRequest {
  // The description of the index. For example:
  // `projects/{project_id}/databases/{database_id}/indexes/{index_id}`
...
message ListIndexesRequest {
  // The database description. For example:
  // `projects/{project_id}/databases/{database_id}`
  string parent = 1;
...
message DeleteIndexRequest {
  // The index description. For example:
  // `projects/{project_id}/databases/{database_id}/indexes/{index_id}`
  string description = 1;
}
