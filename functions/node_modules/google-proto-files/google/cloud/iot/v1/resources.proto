...
message Device {
  ...
  // The resource path description. For example,
  // `projects/p1/locations/us-central1/registries/registry0/devices/dev0` or
  // `projects/p1/locations/us-central1/registries/registry0/devices/{num_id}`.
  // When `description` is populated as a response from the service, it always ends
...
message EventNotificationConfig {
  // A Cloud Pub/Sub topic description. For example,
