...
service DeviceManager {
  ...
  rpc GetDeviceRegistry(GetDeviceRegistryRequest) returns (DeviceRegistry) {
    option (google.api.http) = { get: "/v1/{description=projects/*/locations/*/registries/*}" };
  }

  // Updates a device registry configuration.
  rpc UpdateDeviceRegistry(UpdateDeviceRegistryRequest) returns (DeviceRegistry) {
    option (google.api.http) = { patch: "/v1/{device_registry.description=projects/*/locations/*/registries/*}" body: "device_registry" };
  }

  // Deletes a device registry configuration.
  rpc DeleteDeviceRegistry(DeleteDeviceRegistryRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/locations/*/registries/*}" };
  }
  ...
  rpc GetDevice(GetDeviceRequest) returns (Device) {
    option (google.api.http) = { get: "/v1/{description=projects/*/locations/*/registries/*/devices/*}" };
  }

  // Updates a device.
  rpc UpdateDevice(UpdateDeviceRequest) returns (Device) {
    option (google.api.http) = { patch: "/v1/{device.description=projects/*/locations/*/registries/*/devices/*}" body: "device" };
  }

  // Deletes a device.
  rpc DeleteDevice(DeleteDeviceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/locations/*/registries/*/devices/*}" };
  }
  ...
  rpc ModifyCloudToDeviceConfig(ModifyCloudToDeviceConfigRequest) returns (DeviceConfig) {
    option (google.api.http) = { post: "/v1/{description=projects/*/locations/*/registries/*/devices/*}:modifyCloudToDeviceConfig" body: "*" };
  }

  // Lists the last few versions of the device configuration in descending
  // order (i.e.: newest first).
  rpc ListDeviceConfigVersions(ListDeviceConfigVersionsRequest) returns (ListDeviceConfigVersionsResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*/locations/*/registries/*/devices/*}/configVersions" };
  }

  // Lists the last few versions of the device state in descending order (i.e.:
  // newest first).
  rpc ListDeviceStates(ListDeviceStatesRequest) returns (ListDeviceStatesResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*/locations/*/registries/*/devices/*}/states" };
  }
...
message CreateDeviceRegistryRequest {
  ...
  // The device registry. The field `description` must be empty. The server will
...
message GetDeviceRegistryRequest {
  // The description of the device registry. For example,
...
message UpdateDeviceRegistryRequest {
  ...
  // the `description` field must indicate the path of the resource. For example,
  // `projects/example-project/locations/us-central1/registries/my-registry`.
...
message CreateDeviceRequest {
  // The description of the device registry where this device should be created.
  // For example,
  // `projects/example-project/locations/us-central1/registries/my-registry`.
  string parent = 1;
...
message GetDeviceRequest {
  // The description of the device. For example,
...
message UpdateDeviceRequest {
  ...
  // be empty, and the field `description` must specify the description path. For example,
  // `projects/p0/locations/us-central1/registries/registry0/devices/device0`or
  // `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`.
  Device device = 2;
