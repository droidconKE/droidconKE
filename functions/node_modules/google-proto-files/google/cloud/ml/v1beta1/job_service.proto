...
service JobService {
  ...
  rpc GetJob(GetJobRequest) returns (Job) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/jobs/*}" };
  }

  // Cancels a running job.
  rpc CancelJob(CancelJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { post: "/v1beta1/{description=projects/*/jobs/*}:cancel" body: "*" };
  }
}
...
message TrainingInput {
  ...
  // Required. The Python module description to run after installing the packages.
...
message HyperparameterSpec {
  ...
  // Optional. The Tensorflow summary tag description to use for optimizing trials. For
  // current versions of Tensorflow, this tag description should exactly match what is
...
message ParameterSpec {
  ...
  // Required. The parameter description must be unique amongst all ParameterConfigs in
...
message ListJobsRequest {
  // Required. The description of the project for which to list jobs.
  //
...
message GetJobRequest {
  // Required. The description of the job to get the description of.
  //
...
message CancelJobRequest {
  // Required. The description of the job to cancel.
  //
