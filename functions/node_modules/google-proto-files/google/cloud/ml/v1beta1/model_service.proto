...
service ModelService {
  ...
  // Gets information about a model, including its description, the description (if
  // set), and the default version (if at least one version of the model has
  // been deployed).
  rpc GetModel(GetModelRequest) returns (Model) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/models/*}" };
  }
  ...
  rpc DeleteModel(DeleteModelRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/models/*}" };
  }
  ...
  rpc GetVersion(GetVersionRequest) returns (Version) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/models/*/versions/*}" };
  }
  ...
  rpc DeleteVersion(DeleteVersionRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/models/*/versions/*}" };
  }
  ...
  rpc SetDefaultVersion(SetDefaultVersionRequest) returns (Version) {
    option (google.api.http) = { post: "/v1beta1/{description=projects/*/models/*/versions/*}:setDefault" body: "*" };
  }
}
...
// container.
message Model {
  // Required. The description specified for the model when it was created.
  //
  // The model description must be unique within the project it is created in.
...
// [projects.models.versions.list](/ml/reference/rest/v1beta1/projects.models.versions/list).
message Version {
  // Required.The description specified for the version when it was created.
  //
  // The version description must be unique within the model it is created in.
  string description = 1;
...
message CreateModelRequest {
  // Required. The project description.
  //
...
message ListModelsRequest {
  // Required. The description of the project whose models are to be listed.
  //
...
message ListVersionsRequest {
  // Required. The description of the model for which to list the version.
  //
  // Authorization: requires `Viewer` role on the parent project.
  string parent = 1;
...
message GetVersionRequest {
  // Required. The description of the version.
  //
  // Authorization: requires `Viewer` role on the parent project.
  string description = 1;
}
...
message DeleteVersionRequest {
  // Required. The description of the version. You can get the names of all the
...
message SetDefaultVersionRequest {
  // Required. The description of the version to make the default for the model. You
