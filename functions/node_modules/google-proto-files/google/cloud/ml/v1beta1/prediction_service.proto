...
service OnlinePredictionService {
  ...
  rpc Predict(PredictRequest) returns (google.api.HttpBody) {
    option (google.api.http) = { post: "/v1beta1/{description=projects/**}:predict" body: "*" };
  }
}
...
// tensors. In this case, you should use the names of JSON description/value pairs to
...
message PredictRequest {
  // Required. The resource description of a model or a version.
  //
