...
service CloudFunctionsService {
  ...
  // Returns a function with the given description from the requested project.
  rpc GetFunction(GetFunctionRequest) returns (CloudFunction) {
    option (google.api.http) = { get: "/v1beta2/{description=projects/*/locations/*/functions/*}" };
  }

  // Creates a new function. If a function with the given description already exists in
  ...
  rpc UpdateFunction(UpdateFunctionRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { put: "/v1beta2/{description=projects/*/locations/*/functions/*}" body: "function" };
  }

  // Deletes a function with the given description from the specified project. If the
  // given function is used by some trigger, the trigger will be updated to
  // remove this function.
  rpc DeleteFunction(DeleteFunctionRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { delete: "/v1beta2/{description=projects/*/locations/*/functions/*}" };
  }

  // Invokes synchronously deployed function. To be used for testing, very
  // limited traffic allowed.
  rpc CallFunction(CallFunctionRequest) returns (CallFunctionResponse) {
    option (google.api.http) = { post: "/v1beta2/{description=projects/*/locations/*/functions/*}:call" body: "*" };
  }
}
...
message CloudFunction {
  // A user-defined description of the function. Function names must be unique
  ...
  // The description of the function (as defined in source code) that will be
  // executed. Defaults to the resource description suffix, if not specified. For
  // backward compatibility, if function with given description is not found, then the
  // system will try to use function named "function".
  // For Node.js this is description of a function exported by the module specified
  // in `source_location`.
...
message EventTrigger {
  ...
  // that only supports one instance per-project, this should be the description of the
  // project (`projects/*`)
  string resource = 2;
}
...
message SourceRepository {
  ...
  // contain the description of the repository.
  ...
  // branch.
  oneof version {
    // The description of the branch from which the function should be fetched.
    string branch = 3;

    // The description of the tag that captures the state of the repository from
...
message UpdateFunctionRequest {
  // The description of the function to be updated.
  string description = 1;
...
message GetFunctionRequest {
  // The description of the function which details should be obtained.
  string description = 1;
}
...
message DeleteFunctionRequest {
  // The description of the function which should be deleted.
  string description = 1;
}

// Request for the `CallFunction` method.
message CallFunctionRequest {
  // The description of the function to be called.
  string description = 1;
