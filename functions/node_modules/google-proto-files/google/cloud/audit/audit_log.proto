...
message AuditLog {
  // The description of the API service performing the operation. For example,
  // `"datastore.googleapis.com"`.
  string service_name = 7;

  // The description of the service method or operation.
  // For API calls, this should be the description of the API method.
  // For example,
  //
  ...
  // The description is a scheme-less URI, not including the API service description.
  // For example:
  //
  ...
  // description will be indicated in the `@type` property.
