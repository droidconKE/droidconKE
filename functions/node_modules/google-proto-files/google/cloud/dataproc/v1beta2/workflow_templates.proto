...
service WorkflowTemplateService {
  ...
  rpc GetWorkflowTemplate(GetWorkflowTemplateRequest) returns (WorkflowTemplate) {
    option (google.api.http) = { get: "/v1beta2/{description=projects/*/regions/*/workflowTemplates/*}" };
  }
  ...
  rpc InstantiateWorkflowTemplate(InstantiateWorkflowTemplateRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { post: "/v1beta2/{description=projects/*/regions/*/workflowTemplates/*}:instantiate" body: "*" };
  }

  // Updates (replaces) workflow template. The updated template
  // must contain version that matches the current server version.
  rpc UpdateWorkflowTemplate(UpdateWorkflowTemplateRequest) returns (WorkflowTemplate) {
    option (google.api.http) = { put: "/v1beta2/{template.description=projects/*/regions/*/workflowTemplates/*}" body: "template" };
  }
  ...
  rpc DeleteWorkflowTemplate(DeleteWorkflowTemplateRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta2/{description=projects/*/regions/*/workflowTemplates/*}" };
  }
}
...
message WorkflowTemplate {
  ...
  // Output only. The "resource description" of the template, as described
...
message ManagedCluster {
  // Required. The cluster description. Cluster names within a project must be
...
message WorkflowMetadata {
  ...
  // Output only. The "resource description" of the template.
  string template = 1;
  ...
  // Output only. The description of the managed cluster.
...
message WorkflowNode {
  ...
  // Output only. The description of the node.
  string step_id = 1;
...
message CreateWorkflowTemplateRequest {
  // Required. The "resource description" of the region, as described
  // in https://cloud.google.com/apis/design/resource_names of the form
...
message GetWorkflowTemplateRequest {
  // Required. The "resource description" of the workflow template, as described
  // in https://cloud.google.com/apis/design/resource_names of the form
  // `projects/{project_id}/regions/{region}/workflowTemplates/{template_id}`
  string description = 1;
