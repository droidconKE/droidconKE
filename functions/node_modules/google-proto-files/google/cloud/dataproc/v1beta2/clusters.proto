...
message GceClusterConfig {
  ...
  // present.
  //
  // A full URL, partial URI, or short description are valid. Examples:
  //
...
message InstanceGroupConfig {
  ...
  // (recommended practice is to let Cloud Dataproc derive the description).
...
message ManagedGroupConfig {
  // Output-only. The description of the Instance Template used for the Managed
  // Instance Group.
  string instance_template_name = 1;

  // Output-only. The description of the Instance Group Manager for this group.
...
message AcceleratorConfig {
  // Full URL, partial URI, or short description of the accelerator type resource to
...
message NodeInitializationAction {
  ...
  // description of the executable that caused the error and the exceeded timeout
...
message UpdateClusterRequest {
  ...
  // Required. The cluster description.
  string cluster_name = 2;
...
message ListClustersRequest {
  ...
  // `clusterName` is the description of the cluster provided at creation time.
  ...
  // AND labels.env = staging AND labels.isStarred = *
  string filter = 5;
