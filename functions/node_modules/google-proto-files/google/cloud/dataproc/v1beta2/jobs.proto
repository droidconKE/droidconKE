...
message LoggingConfig {
  ...
  // "root" package description to configure rootLogger.
  // Examples:
...
message HadoopJob {
  ...
  // either the jar file that contains the main class or the main class description.
  // To specify both, add the jar file to `jar_file_uris`, and then specify
  // the main class description in this property.
  oneof driver {
    ...
    // The description of the driver's main class. The jar file containing the class
...
message SparkJob {
  ...
  // description. To pass both a main jar and a main class in that jar, add the jar to
  // `CommonJob.jar_file_uris`, and then specify the main class description in `main_class`.
  oneof driver {
    // The HCFS URI of the jar file that contains the main class.
    string main_jar_file_uri = 1;

    // The description of the driver's main class. The jar file that contains the class
    // must be in the default CLASSPATH or specified in `jar_file_uris`.
    string main_class = 2;
  }
...
message HiveJob {
  ...
  // Hive command: `SET description="value";`).
...
message SparkSqlJob {
  ...
  // Optional. Mapping of query variable names to values (equivalent to the
  // Spark SQL command: SET `description="value";`).
...
message JobPlacement {
  // Required. The description of the cluster where the job will be submitted.
...
message YarnApplication {
  ...
  // Required. The application description.
...
message ListJobsRequest {
  ...
  // Example filter:
  //
  // status.state = ACTIVE AND labels.env = staging AND labels.isStarred = *
  string filter = 7;
}
