...
message RuntimeConfig {
  // The resource description of a runtime config. The description must have the format:
  //
  //     projects/[PROJECT_ID]/configs/[CONFIG_NAME]
  //
  // The `[PROJECT_ID]` must be a valid project ID, and `[CONFIG_NAME]` is an
  // arbitrary description that matches RFC 1035 segment specification. The length of
  // `[CONFIG_NAME]` must be less than 64 bytes.
  //
  // You pick the RuntimeConfig resource description, but the server will validate that
  // the description adheres to this format. After you create the resource, you cannot
...
// The description denotes the hierarchical variable description. For example,
// `ports/serving_port` is a valid variable description. The variable value is an
// opaque string and only leaf variables can have values (that is, variables
// that do not have any child variables).
message Variable {
  // The description of the variable resource, in the format:
  //
  ...
  //
  // Once you create a variable, you cannot change the variable description.
  string description = 1;
...
// documentation.
message Waiter {
  // The description of the Waiter resource, in the format:
  //
  ...
  //
  // After you create a Waiter resource, you cannot change the resource description.
  string description = 1;
