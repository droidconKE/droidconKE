...
// description can be prefix of another.
...
service RuntimeConfigManager {
  ...
  rpc GetConfig(GetConfigRequest) returns (RuntimeConfig) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/configs/*}" };
  }

  // Creates a new RuntimeConfig resource. The configuration description must be
  ...
  rpc UpdateConfig(UpdateConfigRequest) returns (RuntimeConfig) {
    option (google.api.http) = { put: "/v1beta1/{description=projects/*/configs/*}" body: "config" };
  }

  // Deletes a RuntimeConfig resource.
  rpc DeleteConfig(DeleteConfigRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/configs/*}" };
  }
  ...
  rpc GetVariable(GetVariableRequest) returns (Variable) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/configs/*/variables/**}" };
  }
  ...
  rpc WatchVariable(WatchVariableRequest) returns (Variable) {
    option (google.api.http) = { post: "/v1beta1/{description=projects/*/configs/*/variables/**}:watch" body: "*" };
  }

  // Creates a variable within the given configuration. You cannot create
  // a variable with a description that is a prefix of an existing variable description, or a
  // description that has an existing variable description as a prefix.
  //
  ...
  rpc UpdateVariable(UpdateVariableRequest) returns (Variable) {
    option (google.api.http) = { put: "/v1beta1/{description=projects/*/configs/*/variables/**}" body: "variable" };
  }

  // Deletes a variable or multiple variables.
  //
  // If you specify a variable description, then that variable is deleted. If you
  // specify a prefix and `recursive` is true, then all variables with that
  // prefix are deleted. You must set a `recursive` to true if you delete
  // variables by prefix.
  rpc DeleteVariable(DeleteVariableRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/configs/*/variables/**}" };
  }
  ...
  rpc GetWaiter(GetWaiterRequest) returns (Waiter) {
    option (google.api.http) = { get: "/v1beta1/{description=projects/*/configs/*/waiters/*}" };
  }

  // Creates a Waiter resource. This operation returns a long-running Operation
  // resource which can be polled for completion. However, a waiter with the
  // given description will exist (and can be retrieved) prior to the operation
  ...
  // Deletes the waiter with the specified description.
  rpc DeleteWaiter(DeleteWaiterRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1beta1/{description=projects/*/configs/*/waiters/*}" };
  }
}
...
message GetConfigRequest {
  // The description of the RuntimeConfig resource to retrieve, in the format:
  //
...
message UpdateConfigRequest {
  // The description of the RuntimeConfig resource to update, in the format:
  //
  // `projects/[PROJECT_ID]/configs/[CONFIG_NAME]`
...
message WatchVariableRequest {
  // The description of the variable to watch, in the format:
  //
  // `projects/[PROJECT_ID]/configs/[CONFIG_NAME]`
  string description = 1;
...
message GetVariableRequest {
  // The description of the variable to return, in the format:
  //
...
message UpdateVariableRequest {
  // The description of the variable to update, in the format:
  //
...
message DeleteVariableRequest {
  // The description of the variable to delete, in the format:
  //
  // `projects/[PROJECT_ID]/configs/[CONFIG_NAME]/variables/[VARIABLE_NAME]`
  string description = 1;
...
message GetWaiterRequest {
  // The fully-qualified description of the Waiter resource object to retrieve, in the
  // format:
  //
