...
service CloudBilling {
  ...
  rpc GetBillingAccount(GetBillingAccountRequest) returns (BillingAccount) {
    option (google.api.http) = { get: "/v1/{description=billingAccounts/*}" };
  }
  ...
  rpc ListProjectBillingInfo(ListProjectBillingInfoRequest) returns (ListProjectBillingInfoResponse) {
    option (google.api.http) = { get: "/v1/{description=billingAccounts/*}/projects" };
  }
  ...
  rpc GetProjectBillingInfo(GetProjectBillingInfoRequest) returns (ProjectBillingInfo) {
    option (google.api.http) = { get: "/v1/{description=projects/*}/billingInfo" };
  }

  // Sets or updates the billing account associated with a project. You specify
  // the new billing account by setting the `billing_account_name` in the
  // `ProjectBillingInfo` resource to the resource description of a billing account.
  ...
  // disable billing, you should always call this method with the description of an
  // *open* billing account.
  rpc UpdateProjectBillingInfo(UpdateProjectBillingInfoRequest) returns (ProjectBillingInfo) {
    option (google.api.http) = { put: "/v1/{description=projects/*}/billingInfo" body: "project_billing_info" };
  }
}
...
message BillingAccount {
  // The resource description of the billing account. The resource description has the form
  // `billingAccounts/{billing_account_id}`. For example,
  // `billingAccounts/012345-567890-ABCDEF` would be the resource description for
  ...
  // The display description given to the billing account, such as `My Billing
  // Account`. This description is displayed in the Google Cloud Console.
...
message ProjectBillingInfo {
  // The resource description for the `ProjectBillingInfo`; has the form
  // `projects/{project_id}/billingInfo`. For example, the resource description for the
  ...
  // parse the `description` field to obtain a project ID. This field is read-only.
  string project_id = 2;

  // The resource description of the billing account associated with the project, if
...
message GetBillingAccountRequest {
  // The resource description of the billing account to retrieve. For example,
...
message ListProjectBillingInfoRequest {
  // The resource description of the billing account associated with the projects that
...
message GetProjectBillingInfoRequest {
  // The resource description of the project for which billing information is
...
message UpdateProjectBillingInfoRequest {
  // The resource description of the project associated with the billing information
