...
service EntityTypes {
  ...
  rpc GetEntityType(GetEntityTypeRequest) returns (EntityType) {
    option (google.api.http) = { get: "/v2beta1/{description=projects/*/agent/entityTypes/*}" };
  }
  ...
  rpc UpdateEntityType(UpdateEntityTypeRequest) returns (EntityType) {
    option (google.api.http) = { patch: "/v2beta1/{entity_type.description=projects/*/agent/entityTypes/*}" body: "entity_type" };
  }

  // Deletes the specified entity type.
  rpc DeleteEntityType(DeleteEntityTypeRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2beta1/{description=projects/*/agent/entityTypes/*}" };
  }
...
message EntityType {
  ...
  message Entity {
    ...
    //   A canonical description to be used in place of synonyms.
  ...
  // Required. The description of the entity.
...
message GetEntityTypeRequest {
  // Required. The description of the entity type.
...
message DeleteEntityTypeRequest {
  // Required. The description of the entity type to delete.
  // Format: `projects/<Project ID>/agent/entityTypes/<EntityType ID>`.
  string description = 1;
}
...
message BatchUpdateEntityTypesRequest {
  // Required. The description of the agent to update or create entity types in.
  // Format: `projects/<Project ID>/agent`.
  string parent = 1;
  ...
  // * If `description` is specified, we update an existing entity type.
  // * If `description` is not specified, we create a new entity type.
...
message BatchCreateEntitiesRequest {
  // Required. The description of the entity type to create entities in. Format:
  // `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`.
  string parent = 1;
...
message BatchUpdateEntitiesRequest {
  // Required. The description of the entity type to update the entities in. Format:
  // `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`.
  string parent = 1;
...
message BatchDeleteEntitiesRequest {
  // Required. The description of the entity type to delete entries for. Format:
  // `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`.
  string parent = 1;
