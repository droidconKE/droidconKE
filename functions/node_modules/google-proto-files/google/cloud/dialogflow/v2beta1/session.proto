...
message DetectIntentRequest {
  // Required. The description of the session this query is sent to. Format:
...
message QueryResult {
  ...
  // The action description from the matched intent.
  string action = 3;
  ...
  // `output_contexts.parameters` contains entries with description
  // `<parameter description>.original` containing the original parameter values
  // before the query.
  repeated Context output_contexts = 10;

  // The intent that matched the conversational query. Some, not
  // all fields are filled in this message, including but not limited to:
  // `description`, `display_name` and `webhook_state`.
  Intent intent = 11;
...
message StreamingDetectIntentRequest {
  // Required. The description of the session the query is sent to.
...
// Events allow for matching intents by event description instead of the natural
// language input. For instance, input `<event: { description: “welcome_event”,
// parameters: { description: “Sam” } }>` can trigger a personalized welcome response.
// The parameter `description` may be used by the agent in the response:
// `“Hello #welcome_event.description! What can I do for you today?”`.
message EventInput {
