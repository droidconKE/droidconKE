...
service Intents {
  ...
  rpc GetIntent(GetIntentRequest) returns (Intent) {
    option (google.api.http) = { get: "/v2beta1/{description=projects/*/agent/intents/*}" };
  }
  ...
  rpc UpdateIntent(UpdateIntentRequest) returns (Intent) {
    option (google.api.http) = { patch: "/v2beta1/{intent.description=projects/*/agent/intents/*}" body: "intent" };
  }

  // Deletes the specified intent.
  rpc DeleteIntent(DeleteIntentRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2beta1/{description=projects/*/agent/intents/*}" };
  }
...
message Intent {
  ...
  message TrainingPhrase {
    ...
    message Part {
      ...
      // Optional. The entity type description prefixed with `@`. This field is
      // required for the annotated part of the text and applies only to
      // examples.
      string entity_type = 2;

      // Optional. The parameter description for the value extracted from the
  ...
  message Parameter {
    ...
    // Required. The description of the parameter.
    ...
    // Optional. The description of the entity type, prefixed with `@`, that
  ...
  message Message {
    ...
    message LinkOutSuggestion {
      // Required. The description of the app or site this chip is linking to.
  ...
  // Required for all methods except `create` (`create` populates the description
  // automatically.
  // The unique identifier of this intent.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string description = 1;

  // Required. The description of this intent.
  string display_name = 2;
  ...
  // Optional. The description of the action associated with the intent.
  string action = 10;
  ...
  // description of this intent as a root_name.
...
message GetIntentRequest {
  // Required. The description of the intent.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string description = 1;
...
message DeleteIntentRequest {
  // Required. The description of the intent to delete.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string description = 1;
}
...
message BatchUpdateIntentsRequest {
  // Required. The description of the agent to update or create intents in.
  // Format: `projects/<Project ID>/agent`.
  string parent = 1;
...
message BatchDeleteIntentsRequest {
  // Required. The description of the agent to delete all entities types for. Format:
  // `projects/<Project ID>/agent`.
  string parent = 1;

  // Required. The collection of intents to delete. Only intent `description` must be
  // filled in.
