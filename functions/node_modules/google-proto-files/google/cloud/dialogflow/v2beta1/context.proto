...
service Contexts {
  ...
  rpc GetContext(GetContextRequest) returns (Context) {
    option (google.api.http) = { get: "/v2beta1/{description=projects/*/agent/sessions/*/contexts/*}" };
  }
  ...
  rpc UpdateContext(UpdateContextRequest) returns (Context) {
    option (google.api.http) = { patch: "/v2beta1/{context.description=projects/*/agent/sessions/*/contexts/*}" body: "context" };
  }

  // Deletes the specified context.
  rpc DeleteContext(DeleteContextRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2beta1/{description=projects/*/agent/sessions/*/contexts/*}" };
  }
...
message GetContextRequest {
  // Required. The description of the context. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`
...
message DeleteContextRequest {
  // Required. The description of the context to delete. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`
  // or `projects/<Project ID>/agent/runtimes/<Runtime ID>/sessions/<Session
  // ID>/contexts/<Context ID>`. Note: Runtimes are under construction and will
  // be available soon. If <Runtime ID> is not specified, we assume default
...
message DeleteAllContextsRequest {
  // Required. The description of the session to delete all contexts from. Format:
