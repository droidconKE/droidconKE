...
message Entity {
  ...
  // The representative description for the entity.
...
message PartOfSpeech {
  ...
  // This category shows if the token is part of a proper description.
  enum Proper {
...
message ClassificationCategory {
  // The description of the category representing the document.
  string description = 1;
