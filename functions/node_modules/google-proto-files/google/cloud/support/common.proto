...
message SupportAccount {
  ...
  // The resource description for a support account in format
  // `supportAccounts/{account_id}`.
  // Output only.
  string description = 1;

  // Identifier for this entity that gets persisted in storage system. The
  // resource description is populated using this field in format
  // `supportAccounts/{account_id}`.
  string account_id = 2;
  ...
  // A user friendly display description assigned to this support account.
  ...
  // The resource description of a billing account associated with this support
...
message Case {
  ...
  // The resource description for the Case in format
...
message Comment {
  ...
  // The email address/description of user who created this comment.
  // Output only.
  string author = 3;

  // The resource description for this comment in format
...
message IssueTaxonomy {
  ...
  // description for the product (e.g., Google App Engine), languages in which a
  ...
  message Category {
    // User friendly description of this category.
    string display_name = 1;
