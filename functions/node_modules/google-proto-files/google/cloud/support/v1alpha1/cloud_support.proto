...
service CloudSupport {
  ...
  rpc GetSupportAccount(GetSupportAccountRequest) returns (google.cloud.support.common.SupportAccount) {
    option (google.api.http) = { get: "/v1alpha1/{description=supportAccounts/*}" };
  }
  ...
  rpc GetCase(GetCaseRequest) returns (google.cloud.support.common.Case) {
    option (google.api.http) = { get: "/v1alpha1/{description=supportAccounts/*/cases/*}" };
  }
  ...
  rpc ListComments(ListCommentsRequest) returns (ListCommentsResponse) {
    option (google.api.http) = { get: "/v1alpha1/{description=supportAccounts/*/cases/*}/comments" };
  }
  ...
  rpc UpdateCase(UpdateCaseRequest) returns (google.cloud.support.common.Case) {
    option (google.api.http) = { patch: "/v1alpha1/{case.description=supportAccounts/*/cases/*}" body: "case" };
  }

  // Adds a new comment to a case.
  rpc CreateComment(CreateCommentRequest) returns (google.cloud.support.common.Comment) {
    option (google.api.http) = { post: "/v1alpha1/{description=supportAccounts/*/cases/*}/comments" body: "comment" };
  }
...
message GetSupportAccountRequest {
  // The resource description of the support accounts. For example:
...
message ListCommentsRequest {
  // The resource description of case for which comments should be listed.
  string description = 1;
}
...
message CreateCaseRequest {
  // The resource description for `SupportAccount` under which this case is created.
  string parent = 1;
...
message CreateCommentRequest {
  // The resource description of case to which this comment should be added.
  string description = 1;
