...
message TableInfo {
  // A short description for the table, such as`"Analytics Data - Jan 2011"`.
...
message DatasetInfo {
  // A short description for the dataset, such as`"Analytics Data 2011"`.
  string friendly_name = 1;
...
message JobConfiguration {
  ...
  message Query {
    ...
    // If a table description is specified without a dataset in a query,
    // this dataset will be added to table description.
...
// The fully-qualified description for a dataset.
message DatasetName {
  // The project ID.
  string project_id = 1;
...
// The fully-qualified description for a table.
message TableName {
  // The project ID.
  string project_id = 1;
...
// The fully-qualified description for a job.
message JobName {
  // The project ID.
  string project_id = 1;
