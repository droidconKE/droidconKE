...
message TransferConfig {
  // The resource description of the transfer config.
  // Transfer config names have the form
  // `projects/{project_id}/transferConfigs/{config_id}`.
  // Where `config_id` is usually a uuid, even though it is not
  // guaranteed or required. The description is ignored when creating a transfer
  // config.
  ...
  // User specified display description for the data transfer.
...
// Next id: 27
message TransferRun {
  // The resource description of the transfer run.
  // Transfer run names have the form
  // `projects/{project_id}/locations/{location}/transferConfigs/{config_id}/runs/{run_id}`.
  // The description is ignored when creating a transfer run.
  string description = 1;
