...
service DataTransferService {
  ...
  rpc GetDataSource(GetDataSourceRequest) returns (DataSource) {
    option (google.api.http) = {
      get: "/v1/{description=projects/*/locations/*/dataSources/*}"
    };
  }
  ...
  rpc UpdateTransferConfig(UpdateTransferConfigRequest)
    ...
    option (google.api.http) = {
      patch:
          "/v1/{transfer_config.description=projects/*/locations/*/transferConfigs/*}"
      body: "transfer_config"
    };
  }
  ...
  rpc DeleteTransferConfig(DeleteTransferConfigRequest)
    ...
    option (google.api.http) = {
      delete: "/v1/{description=projects/*/locations/*/transferConfigs/*}"
    };
  }
  ...
  rpc GetTransferConfig(GetTransferConfigRequest) returns (TransferConfig) {
    option (google.api.http) = {
      get: "/v1/{description=projects/*/locations/*/transferConfigs/*}"
    };
  }
  ...
  rpc GetTransferRun(GetTransferRunRequest) returns (TransferRun) {
    option (google.api.http) = {
      get: "/v1/{description=projects/*/locations/*/transferConfigs/*/runs/*}"
    };
  }
  ...
  rpc DeleteTransferRun(DeleteTransferRunRequest)
      returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{description=projects/*/locations/*/transferConfigs/*/runs/*}"
    };
  }
  ...
  rpc CheckValidCreds(CheckValidCredsRequest)
    ...
    option (google.api.http) = {
      post: "/v1/{description=projects/*/locations/*/dataSources/*}:checkValidCreds"
      body: "*"
    };
  }
}
...
message DataSourceParameter {
  ...
  // Parameter display description in the user interface.
...
message DataSource {
  ...
  // Data source resource description.
  string description = 1;

  // Data source id.
  string data_source_id = 2;

  // User friendly data source description.
...
message GetDataSourceRequest {
  // The field will contain description of the resource requested, for example:
...
message ListTransferRunsRequest {
  ...
  // Format of transfer configuration resource description is:
  // `projects/{project_id}/transferConfigs/{config_id}`.
  string parent = 1;
...
message ListTransferLogsRequest {
  // Transfer run description in the form:
  // `projects/{project_id}/transferConfigs/{config_Id}/runs/{run_id}`.
  string parent = 1;
...
message ScheduleTransferRunsRequest {
  // Transfer configuration description in the form:
  // `projects/{project_id}/transferConfigs/{config_id}`.
  string parent = 1;
