...
service DatastoreAdmin {
  ...
  rpc ExportEntities(ExportEntitiesRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { post: "/v1beta1/projects/{project_id}:export" body: "*" };
  }
...
message ExportEntitiesRequest {
  ...
  // description of the Cloud Storage bucket and `NAMESPACE_PATH` is an optional Cloud
...
message ImportEntitiesRequest {
  ...
  // `BUCKET_NAME` is the description of the Cloud Storage bucket, `NAMESPACE_PATH` is
