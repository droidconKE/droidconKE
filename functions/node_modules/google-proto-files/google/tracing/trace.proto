...
message StackTrace {
  ...
  message StackFrame {
    ...
    // Used when function description is ‘mangled’. Not guaranteed to be fully
    // qualified but usually it is.
    string orig_function_name = 2;

    // File description of the frame.
    string file_name = 3;
...
message Span {
  ...
  // Name of the span. The span description is sanitized and displayed in the
