...
service IAM {
  ...
  rpc ListServiceAccounts(ListServiceAccountsRequest) returns (ListServiceAccountsResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*}/serviceAccounts" };
  }
  ...
  rpc CreateServiceAccount(CreateServiceAccountRequest) returns (ServiceAccount) {
    option (google.api.http) = { post: "/v1/{description=projects/*}/serviceAccounts" body: "*" };
  }
  ...
  rpc UpdateServiceAccount(ServiceAccount) returns (ServiceAccount) {
    option (google.api.http) = { put: "/v1/{description=projects/*/serviceAccounts/*}" body: "*" };
  }

  // Deletes a [ServiceAccount][google.iam.admin.v1.ServiceAccount].
  rpc DeleteServiceAccount(DeleteServiceAccountRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/serviceAccounts/*}" };
  }
  ...
  rpc ListServiceAccountKeys(ListServiceAccountKeysRequest) returns (ListServiceAccountKeysResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*/serviceAccounts/*}/keys" };
  }
  ...
  rpc CreateServiceAccountKey(CreateServiceAccountKeyRequest) returns (ServiceAccountKey) {
    option (google.api.http) = { post: "/v1/{description=projects/*/serviceAccounts/*}/keys" body: "*" };
  }

  // Deletes a [ServiceAccountKey][google.iam.admin.v1.ServiceAccountKey].
  rpc DeleteServiceAccountKey(DeleteServiceAccountKeyRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/serviceAccounts/*/keys/*}" };
  }

  // Signs a blob using a service account's system-managed private key.
  rpc SignBlob(SignBlobRequest) returns (SignBlobResponse) {
    option (google.api.http) = { post: "/v1/{description=projects/*/serviceAccounts/*}:signBlob" body: "*" };
  }
  ...
  rpc SignJwt(SignJwtRequest) returns (SignJwtResponse) {
    option (google.api.http) = { post: "/v1/{description=projects/*/serviceAccounts/*}:signJwt" body: "*" };
  }
  ...
  rpc GetRole(GetRoleRequest) returns (Role) {
    option (google.api.http) = { get: "/v1/{description=roles/*}" };
  }
  ...
  rpc UpdateRole(UpdateRoleRequest) returns (Role) {
    option (google.api.http) = { patch: "/v1/{description=organizations/*/roles/*}" body: "role" };
  }
  ...
  rpc DeleteRole(DeleteRoleRequest) returns (Role) {
    option (google.api.http) = { delete: "/v1/{description=organizations/*/roles/*}" };
  }

  // Undelete a Role, bringing it back in its previous state.
  rpc UndeleteRole(UndeleteRoleRequest) returns (Role) {
    option (google.api.http) = { post: "/v1/{description=organizations/*/roles/*}:undelete" body: "*" };
  }
...
// `unique_id`.
//
// If the account already exists, the account's resource description is returned
// in util::Status's ResourceInfo.resource_name in the format of
// projects/{PROJECT_ID}/serviceAccounts/{SERVICE_ACCOUNT_EMAIL}. The caller can
// use the description in other methods to access the account.
//
...
message ServiceAccount {
  // The resource description of the service account in the following format:
  // `projects/{PROJECT_ID}/serviceAccounts/{SERVICE_ACCOUNT_EMAIL}`.
  //
  ...
  //
  // In responses the resource description will always be in the format
  // `projects/{PROJECT_ID}/serviceAccounts/{SERVICE_ACCOUNT_EMAIL}`.
...
message CreateServiceAccountRequest {
  // Required. The resource description of the project associated with the service
...
message GetServiceAccountKeyRequest {
  // The resource description of the service account key in the following format:
...
message Role {
  ...
  //
  // When Role is used in CreateRole, the role description must not be set.
  //
  // When Role is used in output and other input such as UpdateRole, the role
  // description is the complete path, e.g., roles/logging.viewer for curated roles
...
message QueryGrantableRolesRequest {
  // Required. The full resource description to query from the list of grantable roles.
  //
  // The description follows the Google Cloud Platform resource format.
...
message ListRolesRequest {
  // The resource description of the parent resource in one of the following formats:
...
message GetRoleRequest {
  // The resource description of the role in one of the following formats:
  // `roles/{ROLE_NAME}`
...
message QueryTestablePermissionsRequest {
  // Required. The full resource description to query from the list of testable
  // permissions.
  //
  // The description follows the Google Cloud Platform resource format.
  // For example, a Cloud Platform project with id `my-project` will be named
