...
service DlpService {
  ...
  rpc UpdateInspectTemplate(UpdateInspectTemplateRequest)
      returns (InspectTemplate) {
    option (google.api.http) = {
      patch: "/v2beta2/{description=organizations/*/inspectTemplates/*}"
      body: "*"
      additional_bindings:
          { patch: "/v2beta2/{description=projects/*/inspectTemplates/*}" body: "*" }
    };
  }
  ...
  rpc GetInspectTemplate(GetInspectTemplateRequest) returns (InspectTemplate) {
    option (google.api.http) = {
      get: "/v2beta2/{description=organizations/*/inspectTemplates/*}"
      additional_bindings {
        get: "/v2beta2/{description=projects/*/inspectTemplates/*}"
      }
    };
  }
  ...
  rpc DeleteInspectTemplate(DeleteInspectTemplateRequest)
    ...
    option (google.api.http) = {
      delete: "/v2beta2/{description=organizations/*/inspectTemplates/*}"
      additional_bindings {
        delete: "/v2beta2/{description=projects/*/inspectTemplates/*}"
      }
    };
  }
  ...
  rpc UpdateDeidentifyTemplate(UpdateDeidentifyTemplateRequest)
      returns (DeidentifyTemplate) {
    option (google.api.http) = {
      patch: "/v2beta2/{description=organizations/*/deidentifyTemplates/*}"
      body: "*"
      additional_bindings: {
        patch: "/v2beta2/{description=projects/*/deidentifyTemplates/*}"
        body: "*"
      }
    };
  }
  ...
  rpc GetDeidentifyTemplate(GetDeidentifyTemplateRequest)
      returns (DeidentifyTemplate) {
    option (google.api.http) = {
      get: "/v2beta2/{description=organizations/*/deidentifyTemplates/*}"
      additional_bindings {
        get: "/v2beta2/{description=projects/*/deidentifyTemplates/*}"
      }
    };
  }
  ...
  rpc DeleteDeidentifyTemplate(DeleteDeidentifyTemplateRequest)
      returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2beta2/{description=organizations/*/deidentifyTemplates/*}"
      additional_bindings {
        delete: "/v2beta2/{description=projects/*/deidentifyTemplates/*}"
      }
    };
  }
  ...
  rpc GetDlpJob(GetDlpJobRequest) returns (DlpJob) {
    option (google.api.http) = { get: "/v2beta2/{description=projects/*/dlpJobs/*}" };
  }
  ...
  rpc DeleteDlpJob(DeleteDlpJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2beta2/{description=projects/*/dlpJobs/*}" };
  }
  ...
  rpc CancelDlpJob(CancelDlpJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { post: "/v2beta2/{description=projects/*/dlpJobs/*}:cancel" body: "*" };
  }
}
...
message RedactImageRequest {
  ...
  // The parent resource description, for example projects/my-project-id.
  string parent = 1;
...
message ReidentifyContentRequest {
  // The parent resource description.
  string parent = 1;
...
message InfoTypeDescription {
  // Internal description of the infoType.
  string description = 1;

  // Human readable form of the infoType description.
...
// Replace each matching finding with the description of the info_type.
...
message CharacterMaskConfig {
  ...
  // alphabetic string such as description, or "0" for a numeric string such as ZIP
...
message CryptoReplaceFfxFpeConfig {
  ...
  // the description of the custom infoType followed by the number of
  // characters comprising the surrogate. The following scheme defines the
  // format: info_type_name(surrogate_character_count):surrogate
  //
  // For example, if the description of custom infoType is 'MY_TOKEN_INFO_TYPE' and
  ...
  //
  // In order for inspection to work properly, the description of this infoType must
  // not occur naturally anywhere in your data; otherwise, inspection may
  // find a surrogate that does not correspond to an actual identifier.
  // Therefore, choose your custom infoType description carefully after considering
  // what your data looks like. One way to select a description that has a high chance
...
message TransientCryptoKey {
  ...
  // A unique key is generated per description: two separate `TransientCryptoKey`
  // protos share the same generated key if their names are the same.
  // When the data crypto key is generated, this description is not used in any way
...
message KmsWrappedCryptoKey {
  ...
  // The resource description of the KMS CryptoKey to use for unwrapping. [required]
...
message InspectTemplate {
  // The template description. Output only.
  //
  ...
  // Display description (max 256 chars).
  string display_name = 2;
...
message CreateInspectTemplateRequest {
  // The parent resource description, for example projects/my-project-id or
...
message UpdateInspectTemplateRequest {
  // Resource description of organization and inspectTemplate to be updated, for
...
message GetInspectTemplateRequest {
  // Resource description of the organization and inspectTemplate to be read, for
  // example `organizations/433245324/inspectTemplates/432452342` or
  // projects/project-id/inspectTemplates/432452342.
  string description = 1;
}
...
message DeleteInspectTemplateRequest {
  // Resource description of the organization and inspectTemplate to be deleted, for
  // example `organizations/433245324/inspectTemplates/432452342` or
  // projects/project-id/inspectTemplates/432452342.
  string description = 1;
}
...
message DlpJob {
  ...
  // The server-assigned description.
  string description = 1;
...
message GetDlpJobRequest {
  // The description of the DlpJob resource.
  string description = 1;
}
...
message CancelDlpJobRequest {
  // The description of the DlpJob resource to be cancelled.
  string description = 1;
}

// The request message for deleting a DLP job.
message DeleteDlpJobRequest {
  // The description of the DlpJob resource to be deleted.
  string description = 1;
}
...
message UpdateDeidentifyTemplateRequest {
  // Resource description of organization and deidentify template to be updated, for
...
message GetDeidentifyTemplateRequest {
  // Resource description of the organization and deidentify template to be read, for
  // example `organizations/433245324/deidentifyTemplates/432452342` or
  // projects/project-id/deidentifyTemplates/432452342.
  string description = 1;
}
...
message DeleteDeidentifyTemplateRequest {
  // Resource description of the organization and deidentify template to be deleted,
