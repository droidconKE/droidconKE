...
// argument to the RPC contains the description of the entity. The result stream
// consists of a sequence of Change messages that the service continues to
// send until the call fails or is cancelled.
//
// ## Data model
//
// This API assumes that each *entity* has a description and a
// set of *elements*, where each element has a description and a value. The
// entity's description must be a unique identifier within the service, such as
// a resource description. What constitutes an entity or element is
...
// entities in the subtree rooted at a particular entity's description.
//
...
// "attendees" } with corresponding values or it may have a single element description
...
message Request {
  ...
  // to watch. Note that the service description **must** be
  ...
  //    of entities in the subtree rooted at the entity's description in `target`. For
  ...
  // parameter description or value, or the non-query parameter portion of `target`
...
message Change {
  ...
  // description. "" refers to the entity itself. The element description is a valid
  // UTF-8 string.
  string element = 1;
