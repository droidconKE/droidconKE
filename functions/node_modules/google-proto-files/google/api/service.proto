...
// describes basic information about a service, such as the description and the
...
//     config_version: 3
//     description: calendar.googleapis.com
//     title: Google Calendar API
//     apis:
//     - description: google.calendar.v3.Calendar
//     authentication:
//       providers:
...
message Service {
  ...
  // A list of API interfaces exported by this service. Only the `description` field
  ...
  // should be listed here by description. Example:
  //
  //     types:
  //     - description: google.protobuf.Int32
  ...
  //
  //     enums:
  //     - description: google.someapi.v1.SomeEnum
  ...
  // with the same description as the service is automatically generated to service all
  // defined APIs.
