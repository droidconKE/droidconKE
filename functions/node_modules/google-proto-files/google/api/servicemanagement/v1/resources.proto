...
message ManagedService {
  // The description of the service. See the [overview](/service-management/overview)
...
message OperationMetadata {
  ...
  // The full description of the resources that this operation is directly
  // associated with.
...
message Diagnostic {
  ...
  // File description and line number of the error or warning.
  string location = 1;
...
message ConfigFile {
  ...
  // The file description of the configuration file (full or relative path).
  string file_path = 1;
...
// Represents a service configuration with its description and id.
message ConfigRef {
  // Resource description of a service config. It must have the following
  // format: "services/{service description}/configs/{config id}".
...
message Rollout {
  ...
  // The description of the service associated with this Rollout.
