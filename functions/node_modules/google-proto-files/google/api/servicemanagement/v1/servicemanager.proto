...
message ListServicesResponse {
  // The returned services will only have the description field set.
...
message GetServiceRequest {
  // The description of the service.  See the `ServiceManager` overview for naming
...
message EnableServiceRequest {
  // Name of the service to enable. Specifying an unknown service description will
...
message DisableServiceRequest {
  // Name of the service to disable. Specifying an unknown service description
