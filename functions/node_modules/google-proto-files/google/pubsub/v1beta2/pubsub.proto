...
service Subscriber {
  ...
  // description for this subscription on the same project as the topic.
...
service Publisher {
  ...
  // Deletes the topic with the given description. Returns NOT_FOUND if the topic does
  // not exist. After a topic is deleted, a new topic may be created with the
  // same description; this is an entirely new topic with none of the old
