...
service Subscriber {
  ...
  //
  // If the description is not provided in the request, the server will assign a random
  // description for this subscription on the same project as the topic, conforming
  // to the
  // [resource description format](https://cloud.google.com/pubsub/docs/overview#names).
  // The generated description is populated in the returned Subscription object.
  // Note that for REST API requests, you must specify a description in the request.
  rpc CreateSubscription(Subscription) returns (Subscription) {
    option (google.api.http) = {
      put: "/v1/{description=projects/*/subscriptions/*}"
      body: "*" };
  }
  ...
  rpc UpdateSubscription(UpdateSubscriptionRequest) returns (Subscription) {
    option (google.api.http) = {
      patch: "/v1/{subscription.description=projects/*/subscriptions/*}"
      body: "*"
    };
  }
  ...
  // the same description, but the new one has no association with the old
  ...
  //
  // If the description is not provided in the request, the server will assign a random
  // description for this snapshot on the same project as the subscription, conforming
  // to the
  // [resource description format](https://cloud.google.com/pubsub/docs/overview#names).
  // The generated description is populated in the returned Snapshot object.
  // Note that for REST API requests, you must specify a description in the request.
  rpc CreateSnapshot(CreateSnapshotRequest) returns (Snapshot) {
    option (google.api.http) = {
      put: "/v1/{description=projects/*/snapshots/*}"
      body: "*"
    };
  }
  ...
  rpc UpdateSnapshot(UpdateSnapshotRequest) returns (Snapshot) {
    option (google.api.http) = {
      patch: "/v1/{snapshot.description=projects/*/snapshots/*}"
      body: "*" };
  }

  // Removes an existing snapshot. All messages retained in the snapshot
  // are immediately dropped. After a snapshot is deleted, a new one may be
  // created with the same description, but the new one has no association with the old
...
// messages to a topic.
service Publisher {
  // Creates the given topic with the given description.
  rpc CreateTopic(Topic) returns (Topic) {
    option (google.api.http) = {
      put: "/v1/{description=projects/*/topics/*}"
      body: "*"
    };
  }
  ...
  rpc UpdateTopic(UpdateTopicRequest) returns (Topic) {
    option (google.api.http) = {
      patch: "/v1/{topic.description=projects/*/topics/*}"
      body: "*" };
  }
  ...
  // Lists the description of the subscriptions for this topic.
  ...
  // Deletes the topic with the given description. Returns `NOT_FOUND` if the topic
  // does not exist. After a topic is deleted, a new topic may be created with
  // the same description; this is an entirely new topic with none of the old
...
// A topic resource.
message Topic {
  // The description of the topic. It must have the format
...
message GetTopicRequest {
  // The description of the topic to get.
...
message ListTopicsRequest {
  // The description of the cloud project that topics belong to.
...
message ListTopicSubscriptionsRequest {
  // The description of the topic that subscriptions are attached to.
  // Format is `projects/{project}/topics/{topic}`.
  string topic = 1;
...
message Subscription {
  // The description of the subscription. It must have the format
  ...
  // The description of the topic from which this subscription is receiving messages.
  // Format is `projects/{project}/topics/{topic}`.
...
message GetSubscriptionRequest {
  // The description of the subscription to get.
...
message ListSubscriptionsRequest {
  // The description of the cloud project that subscriptions belong to.
  // Format is `projects/{project}`.
  string project = 1;
...
message CreateSnapshotRequest {
  // Optional user-provided description for this snapshot.
  // If the description is not provided in the request, the server will assign a random
  // description for this snapshot on the same project as the subscription.
  // Note that for REST API requests, you must specify a description.
...
message Snapshot {
  ...
  // The description of the topic from which this snapshot is retaining messages.
  string topic = 2;
...
message ListSnapshotsRequest {
  // The description of the cloud project that snapshots belong to.
  // Format is `projects/{project}`.
  string project = 1;
...
message DeleteSnapshotRequest {
  // The description of the snapshot to delete.
  // Format is `projects/{project}/snapshots/{snap}`.
  string snapshot = 1;
}
