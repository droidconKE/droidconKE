...
message SourceLocation {
  // Source file description. Depending on the runtime environment, this might be a
  // simple description or a fully-qualified description.
  string file = 1;

  // Line within the source file.
  int64 line = 2;

  // Human-readable description of the function or method being invoked, with optional
  // context such as the class or package description. This information is used in
...
message RequestLog {
  ...
  // example, if the URL was "http://example.com/app?description=val", the resource
  // would be "/app?description=val".  The fragment identifier, which is identified by
  ...
  // Queue description of the request, in the case of an offline request.
  string task_queue_name = 22;

  // Task description of the request, in the case of an offline request.
  string task_name = 23;
