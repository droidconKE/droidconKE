...
message Version {
  ...
  // Relative description of the version within the service.  Example: `v1`.
  // Version names can contain only lowercase letters, numbers, or hyphens.
  // Reserved names: "default", "latest", and any description with the prefix "ah-".
  string id = 2;
...
message Network {
  ...
  // Specify the short description, not the resource path.
  //
  // Defaults to `default`.
