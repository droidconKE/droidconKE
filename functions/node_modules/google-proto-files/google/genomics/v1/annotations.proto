...
message AnnotationSet {
  ...
  // The display description for this annotation set.
...
message Annotation {
  ...
  // The display description of this annotation.
  string description = 3;

  // The ID of the Google Genomics reference associated with this range.
  string reference_id = 4;

  // The display description corresponding to the reference specified by
...
message ExternalId {
  // The description of the source of this data.
...
message UpdateAnnotationSetRequest {
  ...
  // [description][google.genomics.v1.AnnotationSet.description],
...
message SearchAnnotationSetsRequest {
  ...
  // Only return annotations sets for which a substring of the description matches this
...
message UpdateAnnotationRequest {
  ...
  // An optional mask specifying which fields to update. Mutable fields are
  // [description][google.genomics.v1.Annotation.description],
