...
service ReadServiceV1 {
  ...
  // - Unmapped reads will be stripped of positional information (reference description
  // and position)
...
message SearchReadGroupSetsRequest {
  ...
  // Only return read group sets for which a substring of the description matches this
  // string.
...
message UpdateReadGroupSetRequest {
  ...
  //
  // * [description][google.genomics.v1.ReadGroupSet.description].
...
message ListCoverageBucketsRequest {
  ...
  // The description of the reference to query, within the reference set associated
...
message SearchReadsRequest {
  ...
  // The reference sequence description, for example `chr1`, `1`, or `chrX`. If set to
...
message SearchReadsResponse {
  ...
  // ascending lexicographic order by fragment description.
...
message StreamReadsRequest {
  ...
  // The reference sequence description, for example `chr1`,
