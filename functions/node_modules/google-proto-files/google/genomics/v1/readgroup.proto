...
message ReadGroup {
  ...
  message Program {
    ...
    // The display description of the program. This is typically the colloquial description of
  ...
  // value, see [description][google.genomics.v1.ReadGroup.description].
  string id = 1;

  // The dataset to which this read group belongs.
  string dataset_id = 2;

  // The read group description. This corresponds to the @RG ID field in the SAM spec.
  string description = 3;
