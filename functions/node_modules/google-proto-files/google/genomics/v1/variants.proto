...
service StreamingVariantService {
  ...
  // by reference description, position, and ID.
...
message VariantSet {
  ...
  // User-specified, mutable description.
  string description = 7;
...
// a SNP named rs1234 in a call set with the description NA12345.
message VariantCall {
  // The ID of the call set this variant call belongs to.
  string call_set_id = 8;

  // The description of the call set this variant call belongs to.
...
message ReferenceBound {
  // The description of the reference associated with this reference bound.
...
message ImportVariantsRequest {
  ...
  // The reference description is capitalized.
...
message SearchVariantsRequest {
  ...
  // Only return variants which have exactly this description.
...
message SearchCallSetsRequest {
  ...
  // Only return call sets for which a substring of the description matches this
  // string.
  string description = 2;
...
message UpdateCallSetRequest {
  ...
  // mutable field is [description][google.genomics.v1.CallSet.description]. The only
  // acceptable value is "description". If unspecified, all mutable fields will be
  // updated.
  google.protobuf.FieldMask update_mask = 3;
}
