...
message Pipeline {
  ...
  // Required. A user specified pipeline description that does not have to be unique.
  // This description can be used for filtering Pipelines in ListPipelines.
...
message RunPipelineArgs {
  ...
  // Specifically, the description must be 1-63 characters long and match the regular
...
// filtered by description using `namePrefix`: all pipelines with names that
...
message ListPipelinesRequest {
  // Required. The description of the project to search for pipelines. Caller
...
message PipelineResources {
  ...
  message Disk {
    ...
    // Required. The description of the disk that can be used in the pipeline
    // parameters. Must be 1 - 63 characters.
    // The description "boot" is reserved for system use.
    string description = 1;
...
// variable with the given description.  A default value can be optionally
...
//
// ```
// {description: "input_file", localCopy: {path: "file.txt", disk: "pd1"}}
// ```
//
// where `disk` is defined in the `PipelineResources` object as:
//
// ```
// {description: "pd1", mountPoint: "/mnt/disk/"}
// ```
//
...
message PipelineParameter {
  ...
  message LocalCopy {
    ...
    // Required. The description of the disk where this parameter is
    // located. Can be the description of one of the disks specified in the
...
message DockerExecutor {
  // Required. Image description from either Docker Hub or Google Container Registry.
