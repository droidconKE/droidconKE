...
message RepoSource {
  ...
  // Name of the repo. If omitted, the description "default" is assumed.
  string repo_name = 2;
...
message BuildStep {
  // The description of the container image that will run this particular build step.
  //
  ...
  // host's Docker daemon's cache and is available to use as the description for a
  // later build step.
  string description = 1;
...
// - $REPO_NAME: the source repository description specified by RepoSource.
// - $BRANCH_NAME: the branch description specified by RepoSource.
// - $TAG_NAME: the tag description specified by RepoSource.
...
message Secret {
  // Cloud KMS key description to use to decrypt these envs.
  string kms_key_name = 1;

  // Map of environment variable description to its encrypted value.
  //
