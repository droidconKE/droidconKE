...
service TraceService {
  ...
  rpc BatchWriteSpans(BatchWriteSpansRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { post: "/v2/{description=projects/*}/traces:batchWrite" body: "*" };
  }

  // Creates a new span.
  rpc CreateSpan(Span) returns (Span) {
    option (google.api.http) = { post: "/v2/{description=projects/*/traces/*}/spans" body: "*" };
  }
}

// The request message for the `BatchWriteSpans` method.
message BatchWriteSpansRequest {
  // Required. The description of the project where the spans belong. The format is
  // `projects/[PROJECT_ID]`.
