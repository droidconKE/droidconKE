...
message GerritSourceContext {
  ...
  // "project/subproject" is a valid project description. The "repo description" is
  // the hostURI/project.
...
message RepoId {
  // A cloud repo can be identified by either its project ID and repository description
...
// winged-cargo-31) and a repo description within that project.
