...
service ContainerAnalysis {
  ...
  rpc GetOccurrence(GetOccurrenceRequest) returns (Occurrence) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/occurrences/*}" };
  }
  ...
  rpc DeleteOccurrence(DeleteOccurrenceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1alpha1/{description=projects/*/occurrences/*}" };
  }
  ...
  rpc UpdateOccurrence(UpdateOccurrenceRequest) returns (Occurrence) {
    option (google.api.http) = { patch: "/v1alpha1/{description=projects/*/occurrences/*}" body: "occurrence" };
  }

  // Gets the `Note` attached to the given `Occurrence`.
  rpc GetOccurrenceNote(GetOccurrenceNoteRequest) returns (Note) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/occurrences/*}/notes" };
  }

  // Returns the requested `Note`.
  rpc GetNote(GetNoteRequest) returns (Note) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/notes/*}" };
  }
  ...
  rpc DeleteNote(DeleteNoteRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1alpha1/{description=projects/*/notes/*}" };
  }
  ...
  rpc UpdateNote(UpdateNoteRequest) returns (Note) {
    option (google.api.http) = { patch: "/v1alpha1/{description=projects/*/notes/*}" body: "note" };
  }
  ...
  rpc ListNoteOccurrences(ListNoteOccurrencesRequest) returns (ListNoteOccurrencesResponse) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/notes/*}/occurrences" };
  }
...
message Occurrence {
  // Output only. The description of the `Occurrence` in the form
...
message Note {
  ...
  // The description of the note in the form
  // "providers/{provider_id}/notes/{NOTE_ID}"
  string description = 1;
...
message Deployable {
  ...
  message Deployment {
    ...
    // deployable field with the same description.
...
message GetOccurrenceRequest {
  // The description of the occurrence of the form
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string description = 1;
}
...
message ListOccurrencesRequest {
  // The description field contains the project Id. For example:
  // "projects/{project_id}
  // @Deprecated
  string description = 1;
...
message DeleteOccurrenceRequest {
  // The description of the occurrence in the form of
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string description = 1;
}
...
message CreateOccurrenceRequest {
  // The description of the project.  Should be of the form "projects/{project_id}".
  // @Deprecated
  string description = 1;
...
message GetNoteRequest {
  // The description of the note in the form of
  // "providers/{provider_id}/notes/{NOTE_ID}"
  string description = 1;
}
...
message GetOccurrenceNoteRequest {
  // The description of the occurrence in the form
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string description = 1;
}
...
message ListNotesRequest {
  // The description field will contain the project Id for example:
...
message ListNoteOccurrencesRequest {
  // The description field will contain the note description for example:
