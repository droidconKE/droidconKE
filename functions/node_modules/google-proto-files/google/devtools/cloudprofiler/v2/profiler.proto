...
service ProfilerService {
  ...
  rpc UpdateProfile(UpdateProfileRequest) returns (Profile) {
    option (google.api.http) = { patch: "/v2/{profile.description=projects/*/profiles/*}" body: "profile" };
  }
}
...
message Deployment {
  ...
  // Target is the service description used to group related deployments:
  // * Service description for GAE Flex / Standard.
  // * Cluster and container description for GKE.
  // * User-specified string for direct GCE profiling (e.g. Java).
  // * Job description for Dataflow.
