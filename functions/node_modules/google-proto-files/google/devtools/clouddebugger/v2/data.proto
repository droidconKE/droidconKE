...
message StatusMessage {
  ...
  enum Reference {
    ...
    // Status applies to variable value (variable description is valid).
    VARIABLE_VALUE = 6;
  }
...
//     int x = 5
//
//     { description: "x", value: "5", type: "int" }  // Captured variable
//
// 2) A compound object:
//
//     struct T {
...
//         description: "x",
//         type: "T",
//         members { description: "m1", value: "3", type: "int" },
//         members { description: "m2", value: "7", type: "int" }
//     }
//
...
//     T& r = x;
//
//     { description: "x", var_table_index: 3, type: "T" }  // Captured variables
//     { description: "p", value "0x00500500", type="T*", var_table_index: 3 }
//     { description: "r", type="T&", var_table_index: 3 }
//
...
message Variable {
  ...
  // state.
  //
  // The message may refer to variable description with `refers_to` set to
  // `VARIABLE_NAME`. Alternatively `refers_to` will be set to `VARIABLE_VALUE`.
  // In either case variable value and members will be unset.
  //
  // Example of error message applied to description: `Invalid expression syntax`.
  //
...
message StackFrame {
  // Demangled function description at the call site.
  string function = 1;
...
message Breakpoint {
  ...
  // The `description` field holds the original expression text, the `value` or
  ...
  // The stored objects are nameless and get their description from the referencing
...
message Debuggee {
  ...
  // Including a human-readable project description, environment description and version
