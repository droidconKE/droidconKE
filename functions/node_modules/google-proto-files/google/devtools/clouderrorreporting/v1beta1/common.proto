...
message ErrorGroup {
  // The group resource description.
...
message ServiceContext {
  // An identifier of the service, such as the description of the
  // executable, job, or Google App Engine service description. This field is expected
  // to have a low number of values that are relatively stable over time, as
  // opposed to `version`, which can be changed whenever new code is deployed.
  //
  // Contains the service description for error reports extracted from Google
...
message SourceLocation {
  ...
  // Human-readable description of a function or method.
  // The value can include optional context like the class or package description.
