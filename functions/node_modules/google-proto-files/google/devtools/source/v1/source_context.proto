...
message CloudRepoSourceContext {
  ...
  oneof revision {
    ...
    // The description of an alias (branch, tag, etc.).
    string alias_name = 3;
...
message GerritSourceContext {
  ...
  // The full project description within the host. Projects may be nested, so
  // "project/subproject" is a valid project description.
  // The "repo description" is hostURI/project.
...
message RepoId {
  ...
  // repository description combination, or its globally unique identifier.
  oneof id {
    // A combination of a project ID and a repo description.
...
// (e.g. winged-cargo-31) and a repo description within that project.
message ProjectRepoId {
  // The ID of the project.
  string project_id = 1;

  // The description of the repo. Leave empty for the default repo.
  string repo_name = 2;
}
...
message CloudWorkspaceId {
  ...
  // The unique description of the workspace within the repo.  This is the description
