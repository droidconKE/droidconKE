...
service SourceRepo {
  ...
  rpc ListRepos(ListReposRequest) returns (ListReposResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*}/repos" };
  }
  ...
  // Creates a repo in the given project with the given description.
  //
  ...
  rpc DeleteRepo(DeleteRepoRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/repos/**}" };
  }
...
message Repo {
  // Resource description of the repository, of the form
  // `projects/<project>/repos/<repo>`.  The repo description may contain slashes.
  // eg, `projects/myproject/repos/description/with/slash`
...
message GetRepoRequest {
  // The description of the requested repository. Values are of the form
...
message CreateRepoRequest {
  ...
  // The repo to create.  Only description should be set; setting other fields
  // is an error.  The project in the description should match the parent field.
  Repo repo = 2;
}

// Request for DeleteRepo.
message DeleteRepoRequest {
  // The description of the repo to delete. Values are of the form
  // `projects/<project>/repos/<repo>`.
  string description = 1;
}
