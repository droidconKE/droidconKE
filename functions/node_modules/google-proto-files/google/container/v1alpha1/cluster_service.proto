...
service ClusterManager {
  ...
  rpc GetCluster(GetClusterRequest) returns (Cluster) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/locations/*/clusters/*}" };
  }
  ...
  rpc UpdateCluster(UpdateClusterRequest) returns (Operation) {
    option (google.api.http) = { put: "/v1alpha1/{description=projects/*/locations/*/clusters/*}" body: "*" };
  }

  // Updates the version and/or iamge type of a specific node pool.
  rpc UpdateNodePool(UpdateNodePoolRequest) returns (Operation) {
    option (google.api.http) = { put: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}" body: "*" };
  }

  // Sets the autoscaling settings of a specific node pool.
  rpc SetNodePoolAutoscaling(SetNodePoolAutoscalingRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}:setAutoscaling" body: "*" };
  }

  // Sets the logging service of a specific cluster.
  rpc SetLoggingService(SetLoggingServiceRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setLogging" body: "*" };
  }

  // Sets the monitoring service of a specific cluster.
  rpc SetMonitoringService(SetMonitoringServiceRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setMonitoring" body: "*" };
  }

  // Sets the addons of a specific cluster.
  rpc SetAddonsConfig(SetAddonsConfigRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setAddons" body: "*" };
  }

  // Sets the locations of a specific cluster.
  rpc SetLocations(SetLocationsRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setLocations" body: "*" };
  }

  // Updates the master of a specific cluster.
  rpc UpdateMaster(UpdateMasterRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:updateMaster" body: "*" };
  }
  ...
  rpc SetMasterAuth(SetMasterAuthRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setMasterAuth" body: "*" };
  }
  ...
  rpc DeleteCluster(DeleteClusterRequest) returns (Operation) {
    option (google.api.http) = { delete: "/v1alpha1/{description=projects/*/locations/*/clusters/*}" };
  }
  ...
  rpc GetOperation(GetOperationRequest) returns (Operation) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/locations/*/operations/*}" };
  }

  // Cancels the specified operation.
  rpc CancelOperation(CancelOperationRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/operations/*}:cancel" body: "*" };
  }

  // Returns configuration info about the Container Engine service.
  rpc GetServerConfig(GetServerConfigRequest) returns (ServerConfig) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/locations/*}/serverConfig" };
  }
  ...
  rpc GetNodePool(GetNodePoolRequest) returns (NodePool) {
    option (google.api.http) = { get: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}" };
  }
  ...
  rpc DeleteNodePool(DeleteNodePoolRequest) returns (Operation) {
    option (google.api.http) = { delete: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}" };
  }

  // Roll back the previously Aborted or Failed NodePool upgrade.
  // This will be an no-op if the last upgrade successfully completed.
  rpc RollbackNodePoolUpgrade(RollbackNodePoolUpgradeRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}:rollback" body: "*" };
  }

  // Sets the NodeManagement options for a node pool.
  rpc SetNodePoolManagement(SetNodePoolManagementRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}:setManagement" body: "*" };
  }

  // Sets labels on a cluster.
  rpc SetLabels(SetLabelsRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setResourceLabels" body: "*" };
  }

  // Enables or disables the ABAC authorization mechanism on a cluster.
  rpc SetLegacyAbac(SetLegacyAbacRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setLegacyAbac" body: "*" };
  }

  // Start master IP rotation.
  rpc StartIPRotation(StartIPRotationRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:startIpRotation" body: "*" };
  }

  // Completes master IP rotation.
  rpc CompleteIPRotation(CompleteIPRotationRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:completeIpRotation" body: "*" };
  }

  // Sets the size of a specific node pool.
  rpc SetNodePoolSize(SetNodePoolSizeRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*/nodePools/*}:setSize" body: "*" };
  }

  // Enables/Disables Network Policy for a cluster.
  rpc SetNetworkPolicy(SetNetworkPolicyRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setNetworkPolicy" body: "*" };
  }

  // Sets the maintenance policy for a cluster.
  rpc SetMaintenancePolicy(SetMaintenancePolicyRequest) returns (Operation) {
    option (google.api.http) = { post: "/v1alpha1/{description=projects/*/locations/*/clusters/*}:setMaintenancePolicy" body: "*" };
  }
}

// Parameters that describe the nodes in a cluster.
message NodeConfig {
  // The description of a Google Compute Engine [machine
...
message MasterAuthorizedNetworksConfig {
  // CidrBlock contains an optional description and one CIDR block.
  message CidrBlock {
...
message IPAllocationPolicy {
  ...
  // A custom subnetwork description to be used if `create_subnetwork` is true.  If
  // this field is empty, then an automatic description will be chosen for the new
  // subnetwork.
  ...
  // The description of the secondary range to be used for the cluster CIDR
  ...
  // The description of the secondary range to be used as for the services
...
message Cluster {
  ...
  // The description of this cluster. The description must be unique within this project
  ...
  // auto-generated description. Do not use this and a node_pool at the same time.
  ...
  // The description of the Google Compute Engine
  ...
  // [Output only] The description of the Google Compute Engine
...
message GetClusterRequest {
  // The Google Developers Console [project ID or project
  // number](https://support.google.com/cloud/answer/6158840).
  // This field is deprecated, use description instead.
  string project_id = 1;
  ...
  // The description of the cluster to retrieve.
  // This field is deprecated, use description instead.
  string cluster_id = 3;

  // The description (project, location, cluster) of the cluster to retrieve.
...
message UpdateClusterRequest {
  ...
  // The description of the cluster to upgrade.
  // This field is deprecated, use description instead.
  string cluster_id = 3;
  ...
  // The description (project, location, cluster) of the cluster to update.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 5;
}
...
message UpdateNodePoolRequest {
  ...
  // The description of the node pool to upgrade.
  // This field is deprecated, use description instead.
  ...
  // The description (project, location, cluster, node pool) of the node pool to update.
...
message SetNodePoolAutoscalingRequest {
  ...
  // The description (project, location, cluster, node pool) of the node pool to set
...
message SetLoggingServiceRequest {
  ...
  // The description (project, location, cluster) of the cluster to set logging.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 5;
}
...
message SetMonitoringServiceRequest {
  ...
  // The description (project, location, cluster) of the cluster to set monitoring.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message SetAddonsConfigRequest {
  ...
  // The description (project, location, cluster) of the cluster to set addons.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message SetLocationsRequest {
  ...
  // The description (project, location, cluster) of the cluster to set locations.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message SetMasterAuthRequest {
  ...
  // The description (project, location, cluster) of the cluster to set auth.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 7;
}
...
message DeleteClusterRequest {
  ...
  // The description of the cluster to delete.
  // This field is deprecated, use description instead.
  string cluster_id = 3;

  // The description (project, location, cluster) of the cluster to delete.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
...
message GetOperationRequest {
  ...
  // The server-assigned `description` of the operation.
  // This field is deprecated, use description instead.
  string operation_id = 3;

  // The description (project, location, operation id) of the operation to get.
...
message ListOperationsRequest {
  ...
  // The description of the Google Compute Engine [zone](/compute/docs/zones#available)
...
message CancelOperationRequest {
  ...
  // The description (project, location, operation id) of the operation to cancel.
  // Specified in the format 'projects/*/locations/*/operations/*'.
  string description = 4;
}
...
message GetServerConfigRequest {
  ...
  // The description (project and location) of the server config to get
  // Specified in the format 'projects/*/locations/*'.
  string description = 4;
}
...
message DeleteNodePoolRequest {
  ...
  // The description of the node pool to delete.
  // This field is deprecated, use description instead.
  string node_pool_id = 4;

  // The description (project, location, cluster, node pool id) of the node pool to delete.
  // Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
  string description = 6;
}
...
message GetNodePoolRequest {
  ...
  // The description (project, location, cluster, node pool id) of the node pool to get.
  // Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
  string description = 6;
}

// NodePool contains the description and configuration for a cluster's node pool.
...
message SetNodePoolManagementRequest {
  ...
  // The description of the node pool to update.
  // This field is deprecated, use description instead.
  string node_pool_id = 4;
  ...
  // The description (project, location, cluster, node pool id) of the node pool to set
...
message RollbackNodePoolUpgradeRequest {
  ...
  // The description of the cluster to rollback.
  // This field is deprecated, use description instead.
  string cluster_id = 3;

  // The description of the node pool to rollback.
  // This field is deprecated, use description instead.
  string node_pool_id = 4;

  // The description (project, location, cluster, node pool id) of the node poll to
  // rollback upgrade.
  // Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
  string description = 6;
}
...
message SetLabelsRequest {
  ...
  // The description (project, location, cluster id) of the cluster to set labels.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 7;
}
...
message SetLegacyAbacRequest {
  ...
  // The description (project, location, cluster id) of the cluster to set legacy abac.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message StartIPRotationRequest {
  ...
  // The description (project, location, cluster id) of the cluster to start IP rotation.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message CompleteIPRotationRequest {
  ...
  // The description (project, location, cluster id) of the cluster to complete IP rotation.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 7;
}
...
message AcceleratorConfig {
  ...
  // The accelerator type resource description. List of supported accelerators
...
message SetNetworkPolicyRequest {
  ...
  // The description (project, location, cluster id) of the cluster to set networking
  // policy.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 6;
}
...
message SetMaintenancePolicyRequest {
  ...
  // The description (project, location, cluster id) of the cluster to set maintenance
  // policy.
  // Specified in the format 'projects/*/locations/*/clusters/*'.
  string description = 5;
}
