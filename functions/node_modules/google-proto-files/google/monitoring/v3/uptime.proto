...
message UptimeCheckConfig {
  ...
  message InternalChecker {
    ...
    // The checker's human-readable description.
    string display_name = 5;
  }

  // A unique resource description for this UptimeCheckConfig. The format is:
  //
  //
  //   `projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID]`.
  //
  // This field should be omitted when creating the uptime check configuration;
  // on create, the resource description is assigned by the server and included in the
  // response.
  string description = 1;

  // A human-friendly description for the uptime check configuration. The display description
