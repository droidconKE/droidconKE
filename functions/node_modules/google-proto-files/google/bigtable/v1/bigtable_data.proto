...
message Family {
  ...
  // produce cells in a sentinel family with an empty description.
...
// exclusive.
message ColumnRange {
  // The description of the column family within which this range falls.
...
message Mutation {
  ...
  message SetCell {
    // The description of the family into which new data should be written.
  ...
  message DeleteFromColumn {
    // The description of the family from which cells should be deleted.
    // Must match [-_.a-zA-Z0-9]+
    string family_name = 1;
...
message ReadModifyWriteRule {
  // The description of the family to which the read/modify/write should be applied.
  // Must match [-_.a-zA-Z0-9]+
  string family_name = 1;
