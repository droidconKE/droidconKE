...
message ReadRowsRequest {
  // The unique description of the table from which to read.
...
message ReadRowsResponse {
  ...
  message CellChunk {
    ...
    // The column family description for this chunk of data.  If this message
    // is not present this CellChunk is a continuation of the same column
    // family as the previous CellChunk.  The empty string can occur as a
    // column family description in a response so clients must check
...
message SampleRowKeysRequest {
  // The unique description of the table from which to sample row keys.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string table_name = 1;
...
message MutateRowRequest {
  // The unique description of the table to which the mutation should be applied.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string table_name = 1;
...
message MutateRowsRequest {
  ...
  // The unique description of the table to which the mutations should be applied.
  string table_name = 1;
...
message CheckAndMutateRowRequest {
  // The unique description of the table to which the conditional mutation should be
  // applied.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string table_name = 1;
...
message ReadModifyWriteRowRequest {
  // The unique description of the table to which the read/modify/write rules should be
  // applied.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string table_name = 1;
