...
service BigtableInstanceAdmin {
  ...
  rpc GetInstance(GetInstanceRequest) returns (Instance) {
    option (google.api.http) = { get: "/v2/{description=projects/*/instances/*}" };
  }
  ...
  rpc UpdateInstance(Instance) returns (Instance) {
    option (google.api.http) = { put: "/v2/{description=projects/*/instances/*}" body: "*" };
  }

  // Partially updates an instance within a project.
  rpc PartialUpdateInstance(PartialUpdateInstanceRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { patch: "/v2/{instance.description=projects/*/instances/*}" body: "instance" };
  }

  // Delete an instance from a project.
  rpc DeleteInstance(DeleteInstanceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2/{description=projects/*/instances/*}" };
  }
  ...
  rpc GetCluster(GetClusterRequest) returns (Cluster) {
    option (google.api.http) = { get: "/v2/{description=projects/*/instances/*/clusters/*}" };
  }
  ...
  rpc UpdateCluster(Cluster) returns (google.longrunning.Operation) {
    option (google.api.http) = { put: "/v2/{description=projects/*/instances/*/clusters/*}" body: "*" };
  }

  // Deletes a cluster from an instance.
  rpc DeleteCluster(DeleteClusterRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2/{description=projects/*/instances/*/clusters/*}" };
  }
  ...
  rpc GetAppProfile(GetAppProfileRequest) returns (AppProfile) {
    option (google.api.http) = { get: "/v2/{description=projects/*/instances/*/appProfiles/*}" };
  }
  ...
  rpc UpdateAppProfile(UpdateAppProfileRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { patch: "/v2/{app_profile.description=projects/*/instances/*/appProfiles/*}" body: "app_profile" };
  }
  ...
  rpc DeleteAppProfile(DeleteAppProfileRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v2/{description=projects/*/instances/*/appProfiles/*}" };
  }
...
message CreateInstanceRequest {
  // The unique description of the project in which to create the new instance.
...
message GetInstanceRequest {
  // The unique description of the requested instance. Values are of the form
...
message ListInstancesRequest {
  // The unique description of the project for which a list of instances is requested.
  // Values are of the form `projects/<project>`.
  string parent = 1;
...
message DeleteInstanceRequest {
  // The unique description of the instance to be deleted.
...
message CreateClusterRequest {
  // The unique description of the instance in which to create the new cluster.
...
message GetClusterRequest {
  // The unique description of the requested cluster. Values are of the form
...
message ListClustersRequest {
  // The unique description of the instance for which a list of clusters is requested.
  // Values are of the form `projects/<project>/instances/<instance>`.
...
message DeleteClusterRequest {
  // The unique description of the cluster to be deleted. Values are of the form
  // `projects/<project>/instances/<instance>/clusters/<cluster>`.
  string description = 1;
}
...
message CreateAppProfileRequest {
  // The unique description of the instance in which to create the new app profile.
  // Values are of the form
  // `projects/<project>/instances/<instance>`.
  string parent = 1;
...
message GetAppProfileRequest {
  // The unique description of the requested app profile. Values are of the form
...
message ListAppProfilesRequest {
  // The unique description of the instance for which a list of app profiles is
...
message DeleteAppProfileRequest {
  // The unique description of the app profile to be deleted. Values are of the form
  // `projects/<project>/instances/<instance>/appProfiles/<app_profile>`.
  string description = 1;
