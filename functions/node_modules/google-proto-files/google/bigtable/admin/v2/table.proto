...
message Table {
  ...
  enum View {
    ...
    // Only populates `description`.
    NAME_ONLY = 1;

    // Only populates `description` and fields related to the table's schema.
    SCHEMA_VIEW = 2;
    ...
    // deprecation policy.
    //
    // Only populates `description` and fields related to the table's
    // replication state.
    REPLICATION_VIEW = 3;
  ...
  // (`OutputOnly`)
  // The unique description of the table. Values are of the form
...
message Snapshot {
  ...
  // (`OutputOnly`)
  // The unique description of the snapshot.
