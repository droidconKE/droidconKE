...
message Instance {
  ...
  // (`OutputOnly`)
  // The unique description of the instance. Values are of the form
  // `projects/<project>/instances/[a-z][a-z0-9\\-]+[a-z0-9]`.
  string description = 1;

  // The descriptive description for this instance as it appears in UIs.
...
message Cluster {
  ...
  // (`OutputOnly`)
  // The unique description of the cluster. Values are of the form
...
message AppProfile {
  ...
  // (`OutputOnly`)
  // The unique description of the app profile. Values are of the form
