...
message ListZonesRequest {
  // The unique description of the project for which a list of supported zones is
  // requested.
...
message GetClusterRequest {
  // The unique description of the requested cluster.
...
message ListClustersRequest {
  // The unique description of the project for which a list of clusters is requested.
  // Values are of the form projects/<project>
  string description = 1;
}
...
message CreateClusterRequest {
  // The unique description of the zone in which to create the cluster.
  // Values are of the form projects/<project>/zones/<zone>
  string description = 1;

  // The id to be used when referring to the new cluster within its zone,
  // e.g. just the "test-cluster" section of the full description
  // "projects/<project>/zones/<zone>/clusters/test-cluster".
  string cluster_id = 2;

  // The cluster to create.
  // The "description", "delete_time", and "current_operation" fields must be left
  // blank.
  Cluster cluster = 3;
}
...
message DeleteClusterRequest {
  // The unique description of the cluster to be deleted.
  // Values are of the form projects/<project>/zones/<zone>/clusters/<cluster>
  string description = 1;
}
...
message UndeleteClusterRequest {
  // The unique description of the cluster to be un-deleted.
  // Values are of the form projects/<project>/zones/<zone>/clusters/<cluster>
  string description = 1;
}
