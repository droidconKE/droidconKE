...
service BigtableClusterService {
  ...
  rpc ListZones(ListZonesRequest) returns (ListZonesResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*}/zones" };
  }

  // Gets information about a particular cluster.
  rpc GetCluster(GetClusterRequest) returns (Cluster) {
    option (google.api.http) = { get: "/v1/{description=projects/*/zones/*/clusters/*}" };
  }
  ...
  rpc ListClusters(ListClustersRequest) returns (ListClustersResponse) {
    option (google.api.http) = { get: "/v1/{description=projects/*}/aggregated/clusters" };
  }
  ...
  rpc CreateCluster(CreateClusterRequest) returns (Cluster) {
    option (google.api.http) = { post: "/v1/{description=projects/*/zones/*}/clusters" body: "*" };
  }
  ...
  rpc UpdateCluster(Cluster) returns (Cluster) {
    option (google.api.http) = { put: "/v1/{description=projects/*/zones/*/clusters/*}" body: "*" };
  }
  ...
  rpc DeleteCluster(DeleteClusterRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/zones/*/clusters/*}" };
  }
  ...
  rpc UndeleteCluster(UndeleteClusterRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { post: "/v1/{description=projects/*/zones/*/clusters/*}:undelete" body: "" };
  }
}
