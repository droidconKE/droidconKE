...
// In a GcsData, an object's description is the Google Cloud Storage object's description and
// its `lastModificationTime` refers to the object's updated time, which changes
// when the content or the metadata of the object is updated.
message GcsData {
  // Google Cloud Storage bucket description (see
...
// In an AwsS3Data, an object's description is the S3 object's key description.
message AwsS3Data {
  // S3 Bucket description (see
...
// to a data sink, the description of the object at the data sink is
// `<hostname>/<URL-path>`.
//
...
message TransferJob {
  ...
  // A globally unique description assigned by Storage Transfer Service when the
...
message TransferOperation {
  ...
  // The description of the transfer job that triggers this transfer operation.
