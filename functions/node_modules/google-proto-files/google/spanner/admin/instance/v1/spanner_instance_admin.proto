...
service InstanceAdmin {
  ...
  rpc GetInstanceConfig(GetInstanceConfigRequest) returns (InstanceConfig) {
    option (google.api.http) = { get: "/v1/{description=projects/*/instanceConfigs/*}" };
  }
  ...
  rpc GetInstance(GetInstanceRequest) returns (Instance) {
    option (google.api.http) = { get: "/v1/{description=projects/*/instances/*}" };
  }

  // Creates an instance and begins preparing it to begin serving. The
  // returned [long-running operation][google.longrunning.Operation]
  // can be used to track the progress of preparing the new
  // instance. The instance description is assigned by the caller. If the
  ...
  // have a description of the format `<instance_name>/operations/<operation_id>` and
  ...
  // resource [description][google.spanner.admin.instance.v1.Instance.description].
  rpc UpdateInstance(UpdateInstanceRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { patch: "/v1/{instance.description=projects/*/instances/*}" body: "*" };
  }
  ...
  rpc DeleteInstance(DeleteInstanceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/instances/*}" };
  }
...
message InstanceConfig {
  ...
  // The description of this instance configuration as it appears in UIs.
...
message Instance {
  ...
  // segment of the description must be between 6 and 30 characters in length.
  string description = 1;

  // Required. The description of the instance's configuration. Values are of the form
  // `projects/<project>/instanceConfigs/<configuration>`. See
  // also [InstanceConfig][google.spanner.admin.instance.v1.InstanceConfig] and
  // [ListInstanceConfigs][google.spanner.admin.instance.v1.InstanceAdmin.ListInstanceConfigs].
  string config = 2;

  // Required. The descriptive description for this instance as it appears in UIs.
  ...
  // as the string:  description + "_" + value  would prove problematic if we were to
...
message ListInstanceConfigsRequest {
  // Required. The description of the project for which a list of supported instance
...
message GetInstanceConfigRequest {
  // Required. The description of the requested instance configuration. Values are of
...
message GetInstanceRequest {
  // Required. The description of the requested instance. Values are of the form
...
message CreateInstanceRequest {
  // Required. The description of the project in which to create the instance. Values
  ...
  // Required. The instance to create.  The description may be omitted, but if
...
message ListInstancesRequest {
  // Required. The description of the project for which a list of instances is
  ...
  //   * `description`
  //   * `display_name`
  //   * `labels.key` where key is the description of a label
  //
  // Some examples of using filters are:
  //
  //   * `description:*` --> The instance has a description.
  //   * `description:Howl` --> The instance's description contains the string "howl".
  //   * `description:HOWL` --> Equivalent to above.
  //   * `NAME:howl` --> Equivalent to above.
  //   * `labels.env:*` --> The instance has the label "env".
  //   * `labels.env:dev` --> The instance has the label "env" and the value of
  //                        the label contains the string "dev".
  //   * `description:howl labels.env:dev` --> The instance's description contains "howl" and
...
message UpdateInstanceRequest {
  ...
  // description.  Otherwise, only fields mentioned in [][google.spanner.admin.instance.v1.UpdateInstanceRequest.field_mask] need be included.
  Instance instance = 1;
...
message DeleteInstanceRequest {
  // Required. The description of the instance to be deleted. Values are of the form
  // `projects/<project>/instances/<instance>`
  string description = 1;
}
