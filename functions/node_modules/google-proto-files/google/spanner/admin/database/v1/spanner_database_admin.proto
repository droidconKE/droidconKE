...
service DatabaseAdmin {
  ...
  // have a description of the format `<database_name>/operations/<operation_id>` and
  ...
  rpc GetDatabase(GetDatabaseRequest) returns (Database) {
    option (google.api.http) = { get: "/v1/{description=projects/*/instances/*/databases/*}" };
  }

  // Updates the schema of a Cloud Spanner database by
  // creating/altering/dropping tables, columns, indexes, etc. The returned
  // [long-running operation][google.longrunning.Operation] will have a description of
...
message Database {
  ...
  // Required. The description of the database. Values are of the form
  // `projects/<project>/instances/<instance>/databases/<database>`,
  // where `<database>` is as specified in the `CREATE DATABASE`
  // statement. This description can be passed to other API methods to
...
message CreateDatabaseRequest {
  // Required. The description of the instance that will serve the new database.
  // Values are of the form `projects/<project>/instances/<instance>`.
  string parent = 1;
...
message GetDatabaseRequest {
  // Required. The description of the requested database. Values are of the form
  // `projects/<project>/instances/<instance>/databases/<database>`.
  string description = 1;
}
...
// are executable (syntactically valid, description tables that exist, etc.)
...
//
// Each batch of statements is assigned a description which can be used with
...
message UpdateDatabaseDdlRequest {
  ...
  // is used to construct the description of the resulting
  ...
  // [description][google.longrunning.Operation.description] of the resulting
