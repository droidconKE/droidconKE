...
message PartialResultSet {
  ...
  //   * `object`: concatenate the (field description, field value) pairs. If a
  //     field description is duplicated, then apply these rules recursively
...
message ResultSetMetadata {
  ...
  //
  //     "fields": [
  //       { "description": "UserId", "type": { "code": "INT64" } },
  //       { "description": "UserName", "type": { "code": "STRING" } },
  //     ]
