...
service Spanner {
  ...
  rpc GetSession(GetSessionRequest) returns (Session) {
    option (google.api.http) = { get: "/v1/{description=projects/*/instances/*/databases/*/sessions/*}" };
  }
  ...
  rpc DeleteSession(DeleteSessionRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{description=projects/*/instances/*/databases/*/sessions/*}" };
  }
...
message Session {
  // The description of the session. This is always system-assigned; values provided
...
message GetSessionRequest {
  // Required. The description of the session to retrieve.
  string description = 1;
}
...
message DeleteSessionRequest {
  // Required. The description of the session to delete.
  string description = 1;
}
...
message ExecuteSqlRequest {
  ...
  // description. Parameter names consist of any combination of letters,
  // numbers, and underscores.
  //
  // Parameters can appear anywhere that a literal value is expected.  The same
  // parameter description can be used more than once, for example:
...
message ReadRequest {
  ...
  // Required. The description of the table in the database to be read.
  string table = 3;

  // If non-empty, the description of an index on [table][google.spanner.v1.ReadRequest.table]. This index is
  ...
  //
  // It is not an error for the `key_set` to description rows that do not
