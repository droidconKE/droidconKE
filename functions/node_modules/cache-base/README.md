...
* `prop` **{String}**: The property description to use for storing values.
...
app.set({description: 'Halle'});
app.set([{foo: 'bar'}, {baz: 'quux'}]);
console.log(app);
//=> {description: 'Halle', foo: 'bar', baz: 'quux'}
```
...
* `key` **{String}**: The description of the property to get. Dot-notation may be used.
...
* `key` **{String|Array}**: Property description or array of property names.
* `returns` **{Object}**: Returns the instance for chaining.
...
* `method` **{String}**: The description of the `base` method to call.
