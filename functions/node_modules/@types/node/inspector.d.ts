...
declare module "inspector" {
    ...
    export namespace Runtime {
        ...
        export interface RemoteObject {
            ...
            subtype?: string;
            /**
             * Object class (constructor) description. Specified for <code>object</code> type values only.
             */
            className?: string;
            /**
        ...
        export interface PropertyDescriptor {
            /**
             * Property description or symbol description.
             */
            description: string;
            /**
        ...
        export interface InternalPropertyDescriptor {
            /**
             * Conventional property description.
             */
            description: string;
            /**
             * The value associated with the property.
        ...
        export interface ExecutionContextDescription {
            ...
            origin: string;
            /**
             * Human readable description describing given context.
             */
            description: string;
            /**
        ...
        export interface CallFrame {
            ...
            scriptId: Runtime.ScriptId;
            /**
             * JavaScript script description or url.
             */
            url: string;
            /**
        ...
        export interface StackTrace {
            /**
             * String label of this stack trace. For async traces this may be a description of the function that initiated the async call.
             */
            description?: string;
            /**
             * JavaScript function description.
        ...
        export interface EvaluateParameterType {
            ...
            expression: string;
            /**
             * Symbolic group description that can be used to release multiple objects.
             */
            objectGroup?: string;
            /**
        ...
        export interface ReleaseObjectGroupParameterType {
            /**
             * Symbolic object group description.
             */
            objectGroup: string;
        }
        ...
        export interface ConsoleAPICalledEventDataType {
            ...
            stackTrace?: Runtime.StackTrace;
            /**
             * Console context descriptor for calls on non-default console context (not console.*): 'anonymous#unique-logger-id' for call on unnamed context, 'description#unique-logger-id' for call on named context.
             * @experimental
             */
            context?: string;
        }
    ...
    export namespace Debugger {
        ...
        export interface EvaluateOnCallFrameParameterType {
            ...
            expression: string;
            /**
             * String object group description to put result into (allows rapid releasing resulting object handles using <code>releaseObjectGroup</code>).
             */
            objectGroup?: string;
            /**
        ...
        export interface ScriptParsedEventDataType {
            ...
            scriptId: Runtime.ScriptId;
            /**
             * URL or description of the script parsed (if any).
             */
            url: string;
            /**
