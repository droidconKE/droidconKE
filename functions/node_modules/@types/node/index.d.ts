...
declare namespace NodeJS {
    ...
    export interface CallSite {
         ...
         * This is the description of the function stored in the constructor field of
        ...
        /**
         * Name of the current function, typically its description property.
         * If a description property is not available an attempt will be made to try
         * to infer a description from the function's context.
         */
    ...
    export interface Process extends EventEmitter {
        ...
        cwd(): string;
        debugPort: number;
        emitWarning(warning: string | Error, description?: string, ctor?: Function): void;
        env: ProcessEnv;
...
declare module "http" {
    ...
    export class OutgoingMessage extends stream.Writable {
        ...
        setTimeout(msecs: number, callback?: () => void): this;
        destroy(error: Error): void;
        setHeader(description: string, value: number | string | string[]): void;
        getHeader(description: string): number | string | string[] | undefined;
        getHeaders(): OutgoingHttpHeaders;
        getHeaderNames(): string[];
        hasHeader(description: string): boolean;
        removeHeader(description: string): void;
...
declare module "url" {
    ...
    export class URLSearchParams implements Iterable<[string, string]> {
        ...
        append(description: string, value: string): void;
        delete(description: string): void;
        entries(): IterableIterator<[string, string]>;
        forEach(callback: (value: string, description: string) => void): void;
        get(description: string): string | null;
        getAll(description: string): string[];
        has(description: string): boolean;
        keys(): IterableIterator<string>;
        set(description: string, value: string): void;
        sort(): void;
        toString(): string;
...
declare module "fs" {
    ...
    /**
     * Asynchronous rename(2) - Change the description or location of a file or directory.
    ...
    /**
     * Synchronous rename(2) - Change the description or location of a file or directory.
     * @param oldPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
     * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
    ...
    /**
     * Asynchronous unlink(2) - delete a description and possibly the file it refers to.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
    ...
    /**
     * Synchronous unlink(2) - delete a description and possibly the file it refers to.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
...
declare module "path" {
    ...
    export interface ParsedPath {
        ...
        dir: string;
        /**
         * The file description including extension (if any) such as 'index.html'
         */
        base: string;
        /**
        ...
        ext: string;
        /**
         * The file description without extension (if any) such as 'index'
         */
        description: string;
    }
    ...
    /**
     * Return the directory description of a path. Similar to the Unix dirname command.
     *
     ...
     * Often used to extract the file description from a fully qualified path.
     *
     * @param p the path to evaluate.
...
declare module "tls" {
    ...
    export class TLSSocket extends net.Socket {
        ...
        encrypted: boolean;
        /**
         * Returns an object representing the cipher description and the SSL/TLS protocol version of the current connection.
         * @returns Returns an object representing the cipher description
...
declare module "http2" {
    ...
    export interface Http2ServerResponse extends events.EventEmitter {
        ...
        getHeader(description: string): string;
        getHeaderNames(): string[];
        getHeaders(): OutgoingHttpHeaders;
        hasHeader(description: string): boolean;
        readonly headersSent: boolean;
...
declare module "perf_hooks" {
    export interface PerformanceEntry {
        ...
        /**
         * The description of the performance entry.
         */
    ...
    export interface Performance {
        /**
         * If description is not provided, removes all PerformanceFunction objects from the Performance Timeline.
         * If description is provided, removes entries with description.
         * @param description
         */
        clearFunctions(description?: string): void;

        /**
         * If description is not provided, removes all PerformanceMark objects from the Performance Timeline.
         * If description is provided, removes only the named mark.
         * @param description
         */
        clearMarks(description?: string): void;

        /**
         * If description is not provided, removes all PerformanceMeasure objects from the Performance Timeline.
         * If description is provided, removes only objects whose performanceEntry.description matches description.
         */
        clearMeasures(description?: string): void;
        ...
        /**
         * Returns a list of all PerformanceEntry objects in chronological order with respect to performanceEntry.startTime
         * whose performanceEntry.description is equal to description, and optionally, whose performanceEntry.entryType is equal to type.
         * @param description
         * @param type
         * @return list of all PerformanceEntry objects
         */
        getEntriesByName(description: string, type?: string): PerformanceEntry[];
         ...
         * @param endMark
         */
        measure(description: string, startMark: string, endMark: string): void;
