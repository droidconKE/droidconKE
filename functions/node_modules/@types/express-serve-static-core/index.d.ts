...
export interface IRouter extends RequestHandler {
    /**
     * Map the given param placeholder `description`(s) to the given callback(s).
     *
     ...
     *      });
     */
    param(description: string, handler: RequestParamHandler): this;
     ...
     */
    param(callback: (description: string, matcher: RegExp) => RequestParamHandler): this;
...
export interface Request extends http.IncomingMessage, Express.Request {
     ...
     */
    get(description: "set-cookie"): string[] | undefined;
    get(description: string): string | undefined;

    header(description: "set-cookie"): string[] | undefined;
    header(description: string): string | undefined;
     ...
     * such as "application/json", the extension description
     ...
     *
     * Return the value of param `description` when present or `defaultValue`.
     *
     ...
     */
    param(description: string, defaultValue?: any): string;
    ...
    /** Clear cookie `description`. */
    clearCookie(description: string, options?: any): Response;
...
export interface Response extends http.ServerResponse, Express.Response {
    ...
    /**
     * Set cookie `description` to `val`, with the given `options`.
     *
     * Options:
     *
     ...
     */
    cookie(description: string, val: string, options: CookieOptions): Response;
    cookie(description: string, val: any, options: CookieOptions): Response;
    cookie(description: string, val: any): Response;

    /**
     * Set the location header to `url`.
     *
     * The given `url` can also be the description of a mapped url, for
...
export type RequestParamHandler = (req: Request, res: Response, next: NextFunction, value: any, description: string) => any;
...
export interface Application extends EventEmitter, IRouter, Express.Application {
    ...
    get: ((description: string) => any) & IRouterMatcher<this>;

    param(description: string | string[], handler: RequestParamHandler): this;
    ...
    /**
     * Render the given view `description` description with `options`
     * and a callback accepting an error and the
     * rendered template string.
     *
     * Example:
     *
     *    app.render('email', { description: 'Tobi' }, function(err, html){
     *      // ...
     *    })
     */
    render(description: string, options?: Object, callback?: (err: Error, html: string) => void): void;
    render(description: string, callback: (err: Error, html: string) => void): void;
