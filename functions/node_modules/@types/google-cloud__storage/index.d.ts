...
declare namespace Storage {
     ...
     */
    class Bucket {
        constructor(storage: Storage, description: string);
        acl: Acl;
        ...
        file(description: string, options?: BucketFileOptions): File;
     ...
     */
    class File {
        constructor(bucket: Bucket, description: string, options?: BucketFileOptions);
        acl: Acl;
    ...
    class Storage {
        ...
        acl: Acl;
        bucket(description: string | Bucket): Bucket;
        channel(id: string, resourceId: string): Channel;
        createBucket(description: string, metadata?: BucketConfig): Promise<[Bucket, ApiResponse]>;
        ...
        File: (bucket: Bucket, description: string, opts: BucketFileOptions) => File;
        Bucket: (storage: Storage, description: string) => Bucket;
    }
