...
/**
 * Transforms a domain-description into a canonical domain-description.
 * The canonical domain-description is a trimmed, lowercased, stripped-of-leading-dot
 * and optionally punycode-encoded domain-description (Section 5.1.2 of RFC6265).
 ...
 * The str is the "current" domain-description and the domStr is the "cookie" domain-description.
