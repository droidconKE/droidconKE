...
<a description="api_nan_async_worker"></a>
### Nan::AsyncWorker
...
`resource_name` to the constructor. It is recommended that the module description be used as a prefix to the `resource_name` to avoid
...
<a description="api_nan_async_progress_worker"></a>
...
<a description="api_nan_async_progress_queue_worker"></a>
...
<a description="api_nan_async_queue_worker"></a>
