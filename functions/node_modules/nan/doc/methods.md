...
<a description="api_nan_function_callback_info"></a>
...
<a description="api_nan_property_callback_info"></a>
...
<a description="api_nan_return_value"></a>
### Nan::ReturnValue
...
<a description="api_nan_method"></a>
### Method declaration
...
<a description="api_nan_getter"></a>
### Getter declaration
...
<a description="api_nan_setter"></a>
### Setter declaration
...
<a description="api_nan_property_getter"></a>
...
<a description="api_nan_property_setter"></a>
...
<a description="api_nan_property_enumerator"></a>
...
<a description="api_nan_property_deleter"></a>
...
<a description="api_nan_property_query"></a>
...
<a description="api_nan_index_getter"></a>
...
<a description="api_nan_index_setter"></a>
...
<a description="api_nan_index_enumerator"></a>
...
<a description="api_nan_index_deleter"></a>
...
<a description="api_nan_index_query"></a>
...
<a description="api_nan_set_method"></a>
### Nan::SetMethod()

Sets a method with a given description directly on a JavaScript object where the method has the `Nan::FunctionCallback` signature (see <a href="#api_nan_method">Method declaration</a>).
...
<a description="api_nan_set_prototype_method"></a>
### Nan::SetPrototypeMethod()

Sets a method with a given description on a `FunctionTemplate`'s prototype where the method has the `Nan::FunctionCallback` signature (see <a href="#api_nan_method">Method declaration</a>).
...
<a description="api_nan_set_accessor"></a>
### Nan::SetAccessor()

Sets getters and setters for a property with a given description on an `ObjectTemplate` or a plain `Object`. Accepts getters with the `Nan::GetterCallback` signature (see <a href="#api_nan_getter">Getter declaration</a>) and setters with the `Nan::SetterCallback` signature (see <a href="#api_nan_setter">Setter declaration</a>).
...
<a description="api_nan_set_named_property_handler"></a>
...
<a description="api_nan_set_indexed_property_handler"></a>
...
<a description="api_nan_set_template"></a>
### Nan::SetTemplate()
...
<a description="api_nan_set_prototype_template"></a>
...
<a description="api_nan_set_instance_template"></a>
...
<a description="api_nan_set_call_handler"></a>
### Nan::SetCallHandler()
...
<a description="api_nan_set_call_as_function_handler"></a>
