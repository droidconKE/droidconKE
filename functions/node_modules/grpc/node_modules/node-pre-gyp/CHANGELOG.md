...
## 0.5.27
 ...
 - Fixed support for auto-detecting s3 bucket description when it contains `.` - @taavo
...
## 0.5.22
 ...
 - Fixed node-webkit versioning description (NOTE: node-webkit support still experimental)
...
## 0.5.6
 ...
 - Added support for versioning on the `description` value in `package.json` (#57).
