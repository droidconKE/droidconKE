...
<article>
    ...
    <h4 class="description" id="RPCMethod"><span class="type-signature"></span>new RPCMethod<span class="signature">(builder<span class="signature-attributes">non-null</span>, svc<span class="signature-attributes">non-null</span>, description, request, response, request_stream, response_stream, options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
        ...
        <tr>
                ...
                <td class="description"><code>svc</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Method description</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="description"><code>request</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Request message description</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="description"><code>response</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Response message description</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="description"><code>request_stream</code></td>
...
<span class="param-type">boolean</span>
        ...
        <tr>
                ...
                <td class="description"><code>response_stream</code></td>
...
<h4 class="description" id="requestName"><span class="type-signature"></span>requestName<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>Request message description.</p>
</div>
...
<h4 class="description" id="requestStream"><span class="type-signature"></span>requestStream<span class="type-signature"> :bool</span></h4>
...
<h4 class="description" id="resolvedRequestType"><span class="type-signature"></span>resolvedRequestType<span class="type-signature"> :<a href="ProtoBuf.Reflect.Message.html">ProtoBuf.Reflect.Message</a></span></h4>
...
<h4 class="description" id="resolvedResponseType"><span class="type-signature"></span>resolvedResponseType<span class="type-signature"> :<a href="ProtoBuf.Reflect.Message.html">ProtoBuf.Reflect.Message</a></span></h4>
...
<h4 class="description" id="responseName"><span class="type-signature"></span>responseName<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>Response message description.</p>
</div>
...
<h4 class="description" id="responseStream"><span class="type-signature"></span>responseStream<span class="type-signature"> :bool</span></h4>
