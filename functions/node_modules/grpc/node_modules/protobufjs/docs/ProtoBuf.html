...
<h4 class="description" id=".ByteBuffer"><span class="type-signature">(static, non-null) </span>ByteBuffer<span class="type-signature"> :function</span></h4>
...
<h4 class="description" id=".convertFieldsToCamelCase"><span class="type-signature">(static) </span>convertFieldsToCamelCase<span class="type-signature"> :boolean</span></h4>
...
<h4 class="description" id=".ID_MAX"><span class="type-signature">(static, constant) </span>ID_MAX<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".ID_MIN"><span class="type-signature">(static, constant) </span>ID_MIN<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".Lang"><span class="type-signature">(static, non-null) </span>Lang<span class="type-signature"> :Object.&lt;string, !RegExp></span></h4>
...
<h4 class="description" id=".Long"><span class="type-signature">(static, nullable) </span>Long<span class="type-signature"> :function</span></h4>
...
<h4 class="description" id=".MAP_KEY_TYPES"><span class="type-signature">(static, constant, non-null) </span>MAP_KEY_TYPES<span class="type-signature"> :Array.&lt;!Object.&lt;string, {description: string, wireType: number, defaultValue: *}>></span></h4>
...
<span class="param-type">Array.&lt;!Object.&lt;string, {description: string, wireType: number, defaultValue: *}>></span>
...
<h4 class="description" id=".PACKABLE_WIRE_TYPES"><span class="type-signature">(static, constant, non-null) </span>PACKABLE_WIRE_TYPES<span class="type-signature"> :Array.&lt;number></span></h4>
...
<h4 class="description" id=".populateAccessors"><span class="type-signature">(static) </span>populateAccessors<span class="type-signature"> :boolean</span></h4>
...
<h4 class="description" id=".populateDefaults"><span class="type-signature">(static) </span>populateDefaults<span class="type-signature"> :boolean</span></h4>
...
<h4 class="description" id=".TYPES"><span class="type-signature">(static, constant, non-null) </span>TYPES<span class="type-signature"> :Object.&lt;string, {description: string, wireType: number, defaultValue: *}></span></h4>
...
<span class="param-type">Object.&lt;string, {description: string, wireType: number, defaultValue: *}></span>
...
<h4 class="description" id=".VERSION"><span class="type-signature">(static, constant) </span>VERSION<span class="type-signature"> :string</span></h4>
...
<h4 class="description" id=".WIRE_TYPES"><span class="type-signature">(static, constant) </span>WIRE_TYPES<span class="type-signature"> :Object.&lt;string, number></span></h4>
...
<h4 class="description" id=".WIRE_TYPES.BITS32"><span class="type-signature">(static, constant) </span>WIRE_TYPES.BITS32<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".WIRE_TYPES.BITS64"><span class="type-signature">(static, constant) </span>WIRE_TYPES.BITS64<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".WIRE_TYPES.ENDGROUP"><span class="type-signature">(static, constant) </span>WIRE_TYPES.ENDGROUP<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".WIRE_TYPES.LDELIM"><span class="type-signature">(static, constant) </span>WIRE_TYPES.LDELIM<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".WIRE_TYPES.STARTGROUP"><span class="type-signature">(static, constant) </span>WIRE_TYPES.STARTGROUP<span class="type-signature"> :number</span></h4>
...
<h4 class="description" id=".WIRE_TYPES.VARINT"><span class="type-signature">(static) </span>WIRE_TYPES.VARINT<span class="type-signature"> :number</span></h4>
...
<dl class="details">
    ...
    <h4 class="description" id=".loadJson"><span class="type-signature">(static) </span>loadJson<span class="signature">(json, builder<span class="signature-attributes">opt</span>, filename<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="description"><code>json</code></td>
...
<span class="param-type">Object</span>
        ...
        <tr>
                ...
                <td class="description"><code>filename</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The corresponding file description if known. Must be specified for imports.</p></td>
        </tr>
...
<span class="param-type"><a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="description" id=".loadJsonFile"><span class="type-signature">(static) </span>loadJsonFile<span class="signature">(filename, callback<span class="signature-attributes">opt</span>, builder<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>|undefined}</span></h4>
...
<span class="param-type">Object</span>
 ...
 an overridden 'root' path for all imported files.</p></td>
        ...
        <tr>
                ...
                <td class="description"><code>callback</code></td>
...
<span class="param-type">undefined</span>
    ...
    <h4 class="description" id=".loadProto"><span class="type-signature">(static) </span>loadProto<span class="signature">(proto, builder<span class="signature-attributes">opt</span>, filename<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="description"><code>proto</code></td>
...
<span class="param-type"><a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="description" id=".loadProtoFile"><span class="type-signature">(static) </span>loadProtoFile<span class="signature">(filename, callback<span class="signature-attributes">opt</span>, builder<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>|undefined}</span></h4>
...
<span class="param-type">undefined</span>
    ...
    <h4 class="description" id=".newBuilder"><span class="type-signature">(static) </span>newBuilder<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; (non-null) {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
...
<span class="param-type"><a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a></span>
    ...
    <h4 class="description" id=".protoFromFile"><span class="type-signature">(static) </span>protoFromFile<span class="signature">(filename, callback<span class="signature-attributes">opt</span>, builder<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>|undefined}</span></h4>
...
<span class="param-type">undefined</span>
    ...
    <h4 class="description" id=".protoFromString"><span class="type-signature">(static) </span>protoFromString<span class="signature">(proto, builder<span class="signature-attributes">opt</span>, filename<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="ProtoBuf.Builder.html">ProtoBuf.Builder</a>}</span></h4>
