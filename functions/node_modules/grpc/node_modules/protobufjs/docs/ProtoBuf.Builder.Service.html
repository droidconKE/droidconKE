...
<article>
    ...
    <h4 class="description" id="Service"><span class="type-signature"></span>new Service<span class="signature">(rpcImpl<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="description"><code>rpcImpl</code></td>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>RPC implementation receiving the method description and the message</p></td>
        </tr>
...
<h4 class="description" id=".$type"><span class="type-signature">(static, non-null) </span>$type<span class="type-signature"> :<a href="ProtoBuf.Reflect.Service.html">ProtoBuf.Reflect.Service</a></span></h4>
...
<h4 class="description" id="$type"><span class="type-signature">(non-null) </span>$type<span class="type-signature"> :<a href="ProtoBuf.Reflect.Service.html">ProtoBuf.Reflect.Service</a></span></h4>
...
<h4 class="description" id="rpcImpl"><span class="type-signature">(non-null) </span>rpcImpl<span class="type-signature"> :function</span></h4>
...
<dl class="details">
    ...
    <h4 class="description" id=".%5BMethod%5D"><span class="type-signature">(abstract, static) </span>[Method]<span class="signature">(rpcImpl<span class="signature-attributes">non-null</span>, req, callback)</span><span class="type-signature"></span></h4>
...
<span class="param-type">function</span>
        ...
        <tr>
                ...
                <td class="description"><code>req</code></td>
...
<dl class="details">
    ...
    <h4 class="description" id="%5BMethod%5D"><span class="type-signature">(abstract) </span>[Method]<span class="signature">(req, callback)</span><span class="type-signature"></span></h4>
