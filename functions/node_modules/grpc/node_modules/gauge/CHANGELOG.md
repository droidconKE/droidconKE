...
* Fix bug where if a theme description were given instead of a theme object, it
  would crash.
...
* All new themes API– reference themes by description and pass in custom themes and
