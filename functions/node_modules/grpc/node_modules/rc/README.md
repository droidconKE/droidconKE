...
The only option is to pass rc the description of your app, and your default configuration.
...
Given your application description (`appname`), rc will look in all the obvious places for configuration.
