declare module "grpc" {
  ...
  export interface GrpcObject {
    [description: string]: GrpcObject | typeof Client | Message<any>;
  }
  ...
  export class Server {
     ...
     * @param description The description of the method that the provided function should
     *     handle/respond to.
   ...
   */
  export type UntypedServiceImplementation = { [description: string]: handleCall<any, any> };
  ...
  export enum status {
     ...
     * (e.g., a malformed file description).
     */
    INVALID_ARGUMENT = 3,
    /**
   ...
   * @param serviceName The fully qualified description of the service
  ...
  export class Client {
     ...
     * @param method The description of the method to request
